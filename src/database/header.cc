...
const DBHeader::SaveBitmask DBHeader::SAVE_BITMASK_NONE, DBHeader::SAVE_BITMASK_DEP, DBHeader::SAVE_BITMASK_REQUIRED_USE, DBHeader::SAVE_BITMASK_SRC_URI;

const DBHeader::OverlayTest DBHeader::OVTEST_NONE, DBHeader::OVTEST_SAVED_PORTDIR, DBHeader::OVTEST_PATH, DBHeader::OVTEST_ALLPATH, DBHeader::OVTEST_LABEL, DBHeader::OVTEST_NUMBER,
    DBHeader::OVTEST_NOT_SAVED_PORTDIR, DBHeader::OVTEST_ALL;
...
**/
const DBHeader::DBVersion DBHeader::accept[] = {DBHeader::current, 38, 37, 36, 35, 34, 33, 32, 31, 0};

const char DBHeader::magic[] = "coreq\n";
...
void DBHeader::get_overlay_vector(set<ExtendedVersion::Overlay>* overlayset, const char* name, const char* portdir, ExtendedVersion::Overlay minimal, OverlayTest testmode) const {
  for (ExtendedVersion::Overlay curr(minimal); find_overlay(&curr, name, portdir, curr, testmode); ++curr) {
