...
AddOption(PREFIXSTRING, "COREQRC_SOURCE",
	"", P_("COREQRC_SOURCE",
...
AddOption(STRING, "COREQ_SYNC_OPTS",
	"", P_("COREQ_SYNC_OPTS",
...
AddOption(STRING, "COREQ_SYNC_CONF",
	"%{COREQ_SYNC_OPTS}", P_("COREQ_SYNC_CONF",
...
AddOption(STRING, "COREQ_REMOTE_OPTS",
...
AddOption(STRING, "COREQ_TEST_OBSOLETE_OPTS",
	"-d", P_("COREQ_TEST_OBSOLETE_OPTS",
	"This variable contains default options for the coreq-test-obsolete script."));

AddOption(STRING, "COREQ_INSTALLED_AFTER",
	"", P_("COREQ_INSTALLED_AFTER",
	"This variable contains default arguments for the coreq-installed-after script."));

AddOption(PREFIXSTRING, "COREQ_PREFIX",
	COREQ_PREFIX_DEFAULT, P_("COREQ_PREFIX",
...
AddOption(PREFIXSTRING, "EPREFIX",
	"%{COREQ_PREFIX}" EPREFIX_DEFAULT, P_("EPREFIX",
...
AddOption(PREFIXSTRING, "EPREFIX_SOURCE",
	"%{COREQ_PREFIX}", P_("EPREFIX_SOURCE",
...
AddOption(PREFIXSTRING, "EPREFIX_INSTALLED",
	...
	"Prefix to the path where coreq expects information about installed packages."));

AddOption(PREFIXSTRING, "EPREFIX_COREPKG_CACHE",
	"%{EPREFIX}", P_("EPREFIX_COREPKG_CACHE",
	"This prefix is prepended to the corepkg cache."));
...
AddOption(PREFIXSTRING, "EPREFIX_COREPKG_PROFILE",
	"%{EPREFIX_TREE}", P_("EPREFIX_COREPKG_PROFILE",
	"This path is prepended to COREPKG_PROFILE."));

AddOption(PREFIXSTRING, "EPREFIX_VIRTUAL",
	"%{EPREFIX_TREE}", P_("EPREFIX_VIRTUAL",
	"This is prepended to overlays in coreq database to test whether they exist."));
...
AddOption(STRING, "COREQ_TMPDIR",
	"%{TMPDIR}", P_("COREQ_TMPDIR",
...
AddOption(STRING, "COREQ_CACHEFILE",
	"%{EPREFIX}" COREQ_CACHEFILE, P_("COREQ_CACHEFILE",
	"This file is the default coreq cache."));

AddOption(STRING, "COREQ_PREVIOUS",
	"%{EPREFIX}" COREQ_PREVIOUS, P_("COREQ_PREVIOUS",
	"This file is the previous coreq cache (used by coreq-diff and coreq-sync)."));

AddOption(STRING, "COREQ_REMOTE1",
	"%{EPREFIX}" COREQ_REMOTECACHEFILE1, P_("COREQ_REMOTE1",
	"This is the coreq cache used when -R is in effect. If the string is nonempty,\n"
	"coreq-remote uses this file for the output."));

AddOption(STRING, "COREQ_REMOTE2",
	"%{EPREFIX}" COREQ_REMOTECACHEFILE2, P_("COREQ_REMOTE2",
	"This is the coreq cache used when -Z is in effect. If the string is nonempty,\n"
	"coreq-remote uses this file for the output."));

AddOption(INTEGER, "REMOTE_DEFAULT",
	"0", P_("REMOTE_DEFAULT",
	"1, 2, or 0 means that coreq option -R, -Z, or neither is the default."));

AddOption(STRING, "COREQ_REMOTEARCHIVE1",
	"%{EPREFIX}" COREQ_REMOTEARCHIVE1, P_("COREQ_REMOTEARCHIVE1",
	"This is a local copy of the remote archive used by coreq-remote.\n"
	"If the name is empty, only a temporary file is used."));

AddOption(STRING, "COREQ_REMOTEARCHIVE2",
	"%{EPREFIX}" COREQ_REMOTEARCHIVE2, P_("COREQ_REMOTEARCHIVE2",
	"This is a local copy of the remote archive used by coreq-remote.\n"
	"If the name is empty, only a temporary file is used."));

AddOption(STRING, "LOCAL_LAYMAN",
	"", P_("LOCAL_LAYMAN",
	"If nonempty, this will override the heuristics for coreq-remote -L."));

AddOption(STRING, "EBUILD_DEPEND_TEMP",
	"%{EPREFIX_COREPKG_EXEC}/var/cache/edb/dep/aux_db_key_temp", P_("EBUILD_DEPEND_TEMP",
	"The path to the tempfile generated by \"ebuild depend\"."));

AddOption(STRING, "COREQ_WORLD",
	"%{EPREFIX_ROOT}/var/lib/corepkg/world", P_("COREQ_WORLD",
	"This file is considered as the world file."));

AddOption(STRING, "COREQ_WORLD_SETS",
	"%{COREQ_WORLD}_sets", P_("COREQ_WORLD_SETS",
...
AddOption(STRING, "COREQ_USER",
	COREQ_USER, P_("COREQ_USER",
	"Attempt to change to this user if possible. See COREQ_UID."));

AddOption(STRING, "COREQ_GROUP",
	COREQ_GROUP, P_("COREQ_GROUP",
	"Attempt to change to this group if possible. See COREQ_GID."));

AddOption(INTEGER, "COREQ_UID",
	COREQ_UID, P_("COREQ_UID",
	"If COREQ_USER is empty or nonexistent, use this user id.\n"
	"In this case and if $COREQ_UID <= 0, the user id is not changed."));

AddOption(INTEGER, "COREQ_GID",
	COREQ_GID, P_("COREQ_GID",
...
AddOption(STRING, "COREPKG_ROOTPATH",
	COREPKG_ROOTPATH_DEFAULT, P_("COREPKG_ROOTPATH",
...
AddOption(BOOLEAN, "DIFF_ONLY_INSTALLED",
	...
	"If true, coreq-diff will only consider version changes for installed packages."));

AddOption(BOOLEAN, "DIFF_NO_SLOTS",
	"false", P_("DIFF_NO_SLOTS",
	"If true, coreq-diff will not consider slots for version changes."));

AddOption(BOOLEAN, "DIFF_SEPARATE_DELETED",
	"true", P_("DIFF_SEPARATE_DELETED",
	"If false, coreq-diff will mix deleted and changed packages"));
...
AddOption(BOOLEAN, "COREQ_USE_EXPAND",
	"true", P_("COREQ_USE_EXPAND",
	"This variable is only used for delayed substitution.\n"
...
AddOption(BOOLEAN, "UPDATE_VERBOSE",
	...
	"Whether coreq-update -v is on by default (output cache method per ebuild)"));
...
AddOption(STRING, "EBUILD_COREPKG3_0_24",
	"true", P_("EBUILD_COREPKG3_0_24",
...
AddOption(BOOLEAN, "LOCAL_COREPKG_CONFIG",
	"true", P_("LOCAL_COREPKG_CONFIG",
	"If false, /etc/corepkg and ACCEPT_KEYWORDS are ignored."));
...
AddOption(BOOLEAN, "UPGRADE_LOCAL_MODE",
	...
	"If +/-, coreq -u will match as if LOCAL_COREPKG_CONFIG=true/false."));
...
AddOption(BOOLEAN, "COREQ_PRINT_IUSE",
	"true", P_("COREQ_PRINT_IUSE",
...
AddOption(BOOLEAN, "TEST_FOR_EMPTY",
	...
	"Defines whether empty entries in /etc/corepkg/package.* are shown with -t."));

AddOption(BOOLEAN, "TEST_KEYWORDS",
	"true", P_("TEST_KEYWORDS",
	"Defines whether /etc/corepkg/package.accept_keywords is tested with -t."));

AddOption(BOOLEAN, "TEST_MASK",
	"true", P_("TEST_MASK",
	"Defines whether /etc/corepkg/package.mask is tested with -t."));

AddOption(BOOLEAN, "TEST_UNMASK",
	"true", P_("TEST_UNMASK",
	"Defines whether /etc/corepkg/package.unmask is tested with -t."));

AddOption(BOOLEAN, "TEST_USE",
	"true", P_("TEST_USE",
	"Defines whether /etc/corepkg/package.use is tested with -t."));

AddOption(BOOLEAN, "TEST_ENV",
	"true", P_("TEST_ENV",
	"Defines whether /etc/corepkg/package.env is tested with -t."));

AddOption(BOOLEAN, "TEST_LICENSE",
	"true", P_("TEST_LICENSE",
	"Defines whether /etc/corepkg/package.license is tested with -t."));

AddOption(BOOLEAN, "TEST_RESTRICT",
	"true", P_("TEST_RESTRICT",
	"Defines whether /etc/corepkg/package.accept_restrict is tested with -t."));

AddOption(BOOLEAN, "TEST_CFLAGS",
	"true", P_("TEST_CFLAGS",
	"Defines whether /etc/corepkg/package.cflags is tested with -t."));
...
AddOption(BOOLEAN, "SLOT_UPGRADE_ALLOW",
	"%{\\COREQCFGDIR}/package.slot_upgrade_allow", P_("SLOT_UPGRADE_ALLOW",
...
AddOption(STRING, "OBSOLETE_PACKAGE_NOWARN",
	...
	"%{\\COREQCFGDIR}/package.installed.nowarn", P_("OBSOLETE_PACKAGE_NOWARN",
