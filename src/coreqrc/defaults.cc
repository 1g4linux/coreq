...
// check_includes: #include <config.h> include <cstdlib> include "coreqTk/i18n.h" include "coreqTk/dialect.h"
...
AddOption(STRING,
          ...
          "",
          P_("COREQRC",
             "The file which is used instead of /etc/coreqrc and ~/.coreqrc.\n"
...
AddOption(PREFIXSTRING,
          "COREQRC_SOURCE",
          "",
          P_("COREQRC_SOURCE",
             "This path is prepended to source commands in /etc/coreqrc.\n"
             "If set in /etc/coreqrc it temporarily overrides the environment.\n"
...
AddOption(STRING,
          ...
          "",
          P_("COREQ_SYNC_OPTS",
             "This variable is used for delayed substitution in COREQ_SYNC_CONF.\n"
             "It contains code which is evaluated by coreq-sync, so be aware of security!"));

AddOption(STRING,
          "COREQ_SYNC_CONF",
          "%{COREQ_SYNC_OPTS}",
          P_("COREQ_SYNC_CONF",
             "The content of this variable is appended to /etc/coreq-sync.conf\n"
             "In particular, it can be used to override options set in that file.\n"
             "Parts of this variable are evaluated in coreq-sync: Be aware of security!"));

AddOption(STRING,
          "COREQ_REMOTE_OPTS",
          "",
          P_("COREQ_REMOTE_OPTS",
             "This variable contains default options for the coreq-remote script.\n"
             "Note that its content is evaluated, so quote correctly. Typical example:\n"
             "COREQ_REMOTE_OPTS='-f /var/lib/layman/coreq-caches.tar.bz2'"));

AddOption(STRING, "COREQ_TEST_OBSOLETE_OPTS", "-d", P_("COREQ_TEST_OBSOLETE_OPTS", "This variable contains default options for the coreq-test-obsolete script."));

AddOption(STRING, "COREQ_INSTALLED_AFTER", "", P_("COREQ_INSTALLED_AFTER", "This variable contains default arguments for the coreq-installed-after script."));

AddOption(PREFIXSTRING,
          "COREQ_PREFIX",
          COREQ_PREFIX_DEFAULT,
          P_("COREQ_PREFIX",
             "If this variable is set in the environment, then it is prefixed\n"
             "to the path where /etc/coreqrc is searched. If it is not set in the\n"
             "environment, then COREPKG_CONFIGROOT is used instead.\n"
             "If both are unset, the COREQ_PREFIX default value is used instead.\n"
             "Moreover, COREQ_PREFIX is used for delayed substitution for EPREFIX\n"
             "and EPREFIX_SOURCE."));
...
AddOption(PREFIXSTRING,
          ...
          P_("ROOT",
             "This variable is only used for delayed substitution.\n"
             "It influences most paths except for $HOME/.coreqrc, the cache file\n"
             "passed in the command line, COREPKG_PROFILE, PORTDIR,\n"
             "and overlays. In contrast to EPREFIX, further exceptions are:\n"
             "COREPKG_CONFIGROOT, corepkg/scripts-internal stuff and the coreq cachefile."));

AddOption(PREFIXSTRING,
          "EPREFIX",
          "%{COREQ_PREFIX}" EPREFIX_DEFAULT,
          P_("EPREFIX",
             "This variable is used for delayed substitution for path prefixes.\n"
             "It influences most paths except for $HOME/.coreqrc, the cache file\n"
             "passed in the command line, COREPKG_PROFILE, PORTDIR, and overlays."));
...
AddOption(PREFIXSTRING,
          ...
          P_("EPREFIX_TREE",
             "This variable is only used for delayed substitution.\n"
             "It is the path prepended to COREPKG_PROFILE, PORTDIR, and overlays."));
...
AddOption(PREFIXSTRING, "COREPKG_CONFIGROOT", "%{EPREFIX}", P_("COREPKG_CONFIGROOT", "This path is prepended to the /etc paths."));

AddOption(PREFIXSTRING,
          "COREPKG_DEFAULTS",
          "%{EPREFIX}/usr/share/corepkg/config",
          P_("COREPKG_DEFAULTS",
             "This variable is only used for delayed substitution.\n"
             "It is the path prepended to MAKE_GLOBALS and COREPKG_REPOS_CONF."));

AddOption(STRING,
          "MAKE_GLOBALS",
          "%{COREPKG_DEFAULTS}/make.globals",
          P_("MAKE_GLOBALS",
             "This file is used instead of %{COREPKG_CONFIGROOT}/etc/make.globals\n"
             "if it exists. This is reasonable for >=corepkg-2.2*"));

AddOption(STRING,
          "COREPKG_REPOS_CONF",
          "%{COREPKG_DEFAULTS}/repos.conf",
          P_("COREPKG_REPOS_CONF",
             "This file is used to set the default repository information.\n"
             "The file /etc/corepkg/repos.conf is read only after this."));

AddOption(STRING,
          "COREPKG_REPOSITORIES",
          "",
          P_("COREPKG_REPOSITORIES",
             "If this variable is nonempty, its content is used as a substitute\n"
             "for all repos.conf files."));

AddOption(PREFIXSTRING,
          "EPREFIX_COREPKG_EXEC",
          "%{EPREFIX}",
          P_("EPREFIX_COREPKG_EXEC",
             "This might be used as prefix for /usr/bin/ebuild.\n"
             "It is also used as a prefix in the EBUILD_DEPEND_TEMP default."));

AddOption(PREFIXSTRING, "EPREFIX_SOURCE", "%{COREQ_PREFIX}", P_("EPREFIX_SOURCE", "This path is prepended to source commands in /etc/make.{conf,globals}."));

AddOption(PREFIXSTRING, "EPREFIX_INSTALLED", "%{EPREFIX_ROOT}", P_("EPREFIX_INSTALLED", "Prefix to the path where coreq expects information about installed packages."));

AddOption(PREFIXSTRING, "EPREFIX_COREPKG_CACHE", "%{EPREFIX}", P_("EPREFIX_COREPKG_CACHE", "This prefix is prepended to the corepkg cache."));

AddOption(PREFIXSTRING, "EPREFIX_ACCESS_OVERLAYS", "", P_("EPREFIX_ACCESS_OVERLAYS", "This prefix is prepended to overlays when their files are accessed."));

AddOption(PREFIXSTRING, "EPREFIX_PORTDIR", "%{EPREFIX_TREE}", P_("EPREFIX_PORTDIR", "This path is prepended to PORTDIR."));

AddOption(PREFIXSTRING, "EPREFIX_OVERLAYS", "%{EPREFIX_TREE}", P_("EPREFIX_OVERLAYS", "This path is prepended to PORTIDIR_OVERLAY values."));

AddOption(PREFIXSTRING, "EPREFIX_COREPKG_PROFILE", "%{EPREFIX_TREE}", P_("EPREFIX_COREPKG_PROFILE", "This path is prepended to COREPKG_PROFILE."));

AddOption(PREFIXSTRING, "EPREFIX_VIRTUAL", "%{EPREFIX_TREE}", P_("EPREFIX_VIRTUAL", "This is prepended to overlays in coreq database to test whether they exist."));

AddOption(STRING,
          "TMPDIR",
          "",
          P_("TMPDIR",
             "This variable is used for delayed substitution in COREQ_TMPDIR.\n"
             "Usually this is set by the environment variable.\n"
             "coreq exports this variable initialized to COREQ_TMPDIR."));
...
AddOption(STRING,
          ...
          P_("COREQ_TMPDIR",
             ...
             "temporary files. coreq exports this variable as TMPDIR."));

AddOption(STRING, "COREQ_CACHEFILE", "%{EPREFIX}" COREQ_CACHEFILE, P_("COREQ_CACHEFILE", "This file is the default coreq cache."));

AddOption(STRING, "COREQ_PREVIOUS", "%{EPREFIX}" COREQ_PREVIOUS, P_("COREQ_PREVIOUS", "This file is the previous coreq cache (used by coreq-diff and coreq-sync)."));

AddOption(STRING,
          "COREQ_REMOTE1",
          "%{EPREFIX}" COREQ_REMOTECACHEFILE1,
          P_("COREQ_REMOTE1",
             "This is the coreq cache used when -R is in effect. If the string is nonempty,\n"
             "coreq-remote uses this file for the output."));

AddOption(STRING,
          "COREQ_REMOTE2",
          "%{EPREFIX}" COREQ_REMOTECACHEFILE2,
          P_("COREQ_REMOTE2",
             "This is the coreq cache used when -Z is in effect. If the string is nonempty,\n"
             "coreq-remote uses this file for the output."));

AddOption(INTEGER, "REMOTE_DEFAULT", "0", P_("REMOTE_DEFAULT", "1, 2, or 0 means that coreq option -R, -Z, or neither is the default."));

AddOption(STRING,
          "COREQ_REMOTEARCHIVE1",
          "%{EPREFIX}" COREQ_REMOTEARCHIVE1,
          P_("COREQ_REMOTEARCHIVE1",
             "This is a local copy of the remote archive used by coreq-remote.\n"
             "If the name is empty, only a temporary file is used."));

AddOption(STRING,
          "COREQ_REMOTEARCHIVE2",
          "%{EPREFIX}" COREQ_REMOTEARCHIVE2,
          P_("COREQ_REMOTEARCHIVE2",
             "This is a local copy of the remote archive used by coreq-remote.\n"
             "If the name is empty, only a temporary file is used."));

AddOption(STRING, "LOCAL_LAYMAN", "", P_("LOCAL_LAYMAN", "If nonempty, this will override the heuristics for coreq-remote -L."));

AddOption(STRING, "EBUILD_DEPEND_TEMP", "%{EPREFIX_COREPKG_EXEC}/var/cache/edb/dep/aux_db_key_temp", P_("EBUILD_DEPEND_TEMP", "The path to the tempfile generated by \"ebuild depend\"."));

AddOption(STRING, "COREQ_WORLD", "%{EPREFIX_ROOT}/var/lib/corepkg/world", P_("COREQ_WORLD", "This file is considered as the world file."));

AddOption(STRING, "COREQ_WORLD_SETS", "%{COREQ_WORLD}_sets", P_("COREQ_WORLD_SETS", "This file is considered as the world_sets file."));
...
AddOption(BOOLEAN, "CURRENT_WORLD", "true", P_("CURRENT_WORLD", "Prefer the current world file (if readable) over the data in the cachefile."));

AddOption(STRING, "COREQ_USER", COREQ_USER, P_("COREQ_USER", "Attempt to change to this user if possible. See COREQ_UID."));

AddOption(STRING, "COREQ_GROUP", COREQ_GROUP, P_("COREQ_GROUP", "Attempt to change to this group if possible. See COREQ_GID."));

AddOption(INTEGER,
          "COREQ_UID",
          COREQ_UID,
          P_("COREQ_UID",
             "If COREQ_USER is empty or nonexistent, use this user id.\n"
             "In this case and if $COREQ_UID <= 0, the user id is not changed."));

AddOption(INTEGER,
          "COREQ_GID",
          COREQ_GID,
          P_("COREQ_GID",
             "If COREQ_GROUP is empty or nonexistent, use this group id.\n"
             "In this case and if $COREQ_GID <= 0, the group id is not changed."));
...
AddOption(BOOLEAN, "NODROP_FATAL", "false", P_("NODROP_FATAL", "If true, a negative result of REQUIRE_DROP raises an error."));

AddOption(STRING,
          "COREPKG_ROOTPATH",
          COREPKG_ROOTPATH_DEFAULT,
          P_("COREPKG_ROOTPATH",
             "This variable is passed unchanged to ebuild.sh\n"
             "Usually ebuild.sh uses it to calculate the PATH."));

AddOption(STRING, "DEFAULT_ARCH", ARCH_DEFAULT, P_("DEFAULT_ARCH", "The default ARCH if none is specified by the profile."));

AddOption(INTEGER,
          "NOFOUND_STATUS",
          EXPAND_STRINGIFY(EXIT_FAILURE),
          P_("NOFOUND_STATUS",
...
AddOption(INTEGER,
          "COREQ_LIMIT_COMPACT",
          "200",
          P_("COREQ_LIMIT_COMPACT",
             "The maximal number of matches shown on terminal in compact mode.\n"
             "The value 0 means all matches are shown."));

AddOption(BOOLEAN, "QUICKMODE", "false", P_("QUICKMODE", "Whether --quick is on by default."));

AddOption(BOOLEAN, "CAREMODE", "false", P_("CAREMODE", "Whether --care is on."));
...
AddOption(BOOLEAN,
          ...
          P_("USE_BUILD_TIME",
             ...
             "The BUILD_TIME exists only for packages emerged with >=corepkg-2.2_rc63"));

AddOption(BOOLEAN, "QUIETMODE", "false", P_("QUIETMODE", "Whether --quiet is on by default."));
...
AddOption(STRING,
          ...
          P_("PRINT_APPEND",
             ...
             "VAR=`PRINT_APPEND=x coreq --print VAR` ; VAR=${VAR%x}"));

AddOption(BOOLEAN, "DIFF_ONLY_INSTALLED", "false", P_("DIFF_ONLY_INSTALLED", "If true, coreq-diff will only consider version changes for installed packages."));

AddOption(BOOLEAN, "DIFF_NO_SLOTS", "false", P_("DIFF_NO_SLOTS", "If true, coreq-diff will not consider slots for version changes."));

AddOption(BOOLEAN, "DIFF_SEPARATE_DELETED", "true", P_("DIFF_SEPARATE_DELETED", "If false, coreq-diff will mix deleted and changed packages"));
...
AddOption(BOOLEAN, "RESTRICT_INSTALLED", "true", P_("RESTRICT_INSTALLED", "If true, calculate RESTRICT/PROPERTIES for installed versions."));

AddOption(BOOLEAN,
          "CARE_RESTRICT_INSTALLED",
          "true",
          P_("CARE_RESTRICT_INSTALLED",
...
AddOption(BOOLEAN,
          ...
          DEP_DEFAULT,
          P_("DEP",
             "If true, store/use {R,P,B,}DEPEND (e.g. shown with coreq -lv).\n"
...
AddOption(BOOLEAN,
          ...
          SRC_URI_DEFAULT,
          P_("SRC_URI",
             "If true, store/use SRC_URI (e.g. shown with coreq -lv).\n"
             "Usage of SRC_URI roughly doubles disk resp. memory requirements."));

AddOption(BOOLEAN, "REQUIRED_USE", REQUIRED_USE_DEFAULT, P_("REQUIRED_USE", "If true, store/use REQUIRED_USE. Usage increases disk/memory requirements."));

AddOption(STRING, "DEFAULT_FORMAT", "normal", P_("DEFAULT_FORMAT", "Defines whether --compact or --verbose is on by default."));

AddOption(STRING,
          "PRINT_COUNT_ALWAYS",
          "false",
          P_("PRINT_COUNT_ALWAYS",
             "Allowed values are true/false/never.\n"
             "If true, always print the number of matches (even 0 or 1) in the last line."));

AddOption(BOOLEAN, "NOCOLORS", "%{NOCOLOR}", P_("NOCOLORS", "Do not output colors."));

AddOption(BOOLEAN, "NOSTATUSLINE", "%{NOCOLOR}", P_("NOSTATUSLINE", "Do not output status line."));

AddOption(BOOLEAN, "NOPERCENTAGE", "%{NOCOLOR}", P_("NOPERCENTAGE", "Do not output percentage progress."));
...
AddOption(BOOLEAN, "FORCE_COLORS", "%{FORCE_USECOLORS}", P_("FORCE_COLORS", "Output colors even if not printing to a terminal."));

AddOption(BOOLEAN, "FORCE_STATUSLINE", "%{FORCE_USECOLORS}", P_("FORCE_STATUSLINE", "Output status line even if not printing to a terminal."));

AddOption(BOOLEAN, "FORCE_PERCENTAGE", "%{FORCE_USECOLORS}", P_("FORCE_PERCENTAGE", "Output percentage progress even if not printing to a terminal."));
...
AddOption(BOOLEAN, "STYLE_VERSION_SORTED", "false", P_("STYLE_VERSION_SORTED", "Defines whether --versionsorted is on by default."));

AddOption(BOOLEAN, "STYLE_VERSION_LINES", "false", P_("STYLE_VERSION_LINES", "Defines whether --versionlines is on by default."));
...
AddOption(BOOLEAN, "DEFAULT_IS_OR", "false", P_("DEFAULT_IS_OR", "Whether default concatenation of queries is -o (or) or -a (and)"));

AddOption(BOOLEAN, "DUP_PACKAGES_ONLY_OVERLAYS", "false", P_("DUP_PACKAGES_ONLY_OVERLAYS", "Whether checks for duplicate packages occur only among overlays"));

AddOption(BOOLEAN, "DUP_VERSIONS_ONLY_OVERLAYS", "false", P_("DUP_VERSIONS_ONLY_OVERLAYS", "Whether checks for duplicate versions occur only among overlays"));

AddOption(STRING, "OVERLAYS_LIST", "all-used-renumbered", P_("OVERLAYS_LIST", "Which overlays to list (all/all-if-used/all-used/all-used-renumbered/no)"));

AddOption(INTEGER,
          "LEVENSHTEIN_DISTANCE",
          LEVENSHTEIN_DISTANCE_DEFAULT,
          P_("LEVENSHTEIN_DISTANCE",
             "The default maximal levensthein distance for which a string is\n"
             "considered a match for the fuzzy match algorithm."));

AddOption(BOOLEAN, "UPDATE_VERBOSE", "false", P_("UPDATE_VERBOSE", "Whether coreq-update -v is on by default (output cache method per ebuild)"));

AddOption(STRING, "CACHE_METHOD_PARSE", "#metadata-md5#metadata-flat#assign", P_("CACHE_METHOD_PARSE", "This string is appended to all cache methods using parse[*] or ebuild[*]."));

AddOption(STRING,
          "PORTDIR_CACHE_METHOD",
          PORTDIR_CACHE_METHOD,
          P_("PORTDIR_CACHE_METHOD",
             "CorePkg cache-backend that should be used for PORTDIR\n"
             "(metadata[:*]/sqlite/flat[:*]/corepkg-2.1/parse[*][|]ebuild[*]/coreq[*][:*])"));

AddOption(STRING,
          "OVERLAY_CACHE_METHOD",
          "parse|ebuild*",
          P_("OVERLAY_CACHE_METHOD",
             "CorePkg cache-backend that should be used for the overlays.\n"
             "(metadata[:*]/sqlite/flat[:*]/corepkg-2.1/parse[*][|]ebuild[*]/coreq[*][:*])"));
...
AddOption(STRING, "EXCLUDE_OVERLAY", "", P_("EXCLUDE_OVERLAY", "List of overlays that should be excluded from the index."));

AddOption(STRING, "ADD_OVERLAY", "", P_("ADD_OVERLAY", "List of overlays that should be added to the index."));

AddOption(BOOLEAN, "EXPORT_PORTDIR_OVERLAY", "true", P_("EXPORT_PORTDIR_OVERLAY", "If true and overlays are excluded or added, export modified PORTDIR_OVERLAY."));
...
AddOption(BOOLEAN, "LOCAL_COREPKG_CONFIG", "true", P_("LOCAL_COREPKG_CONFIG", "If false, /etc/corepkg and ACCEPT_KEYWORDS are ignored."));

AddOption(BOOLEAN,
          "ALWAYS_ACCEPT_KEYWORDS",
          ALWAYS_ACCEPT_KEYWORDS_DEFAULT,
          P_("ALWAYS_ACCEPT_KEYWORDS",
             "If true, ACCEPT_KEYWORDS is used even without LOCAL_COREPKG_CONFIG,\n"
             "e.g. to determine the \"default\" stability."));

AddOption(BOOLEAN, "UPGRADE_LOCAL_MODE", "", P_("UPGRADE_LOCAL_MODE", "If +/-, coreq -u will match as if LOCAL_COREPKG_CONFIG=true/false."));
...
AddOption(BOOLEAN,
          ...
          P_("RECOMMEND_LOCAL_MODE",
             ...
             "LOCAL_COREPKG_CONFIG=true/false."));

AddOption(BOOLEAN, "RECURSIVE_SETS", "true", P_("RECURSIVE_SETS", "Are packages/sets in included sets part of the parent set?"));
#endif

#if defined(JUMBO_BUILD) || (DEFAULT_PART == 2)

AddOption(BOOLEAN,
          "UPGRADE_TO_HIGHEST_SLOT",
          "true",
          P_("UPGRADE_TO_HIGHEST_SLOT",
...
AddOption(BOOLEAN, "COUNT_ONLY_PRINTED", "true", P_("COUNT_ONLY_PRINTED", "If false, count independently of whether the matches are printed."));
...
AddOption(BOOLEAN,
          ...
          "true",
          P_("DIFF_PRINT_INSTALLED",
             "This variable is only used for delayed substitution.\n"
             "It defines whether coreq-diff will output installed versions."));
...
AddOption(BOOLEAN,
          ...
          P_("COREQ_PRINT_IUSE",
             ...
             "If false, no IUSE data is printed for coreq. See also VERSION_IUSE_*"));
...
AddOption(BOOLEAN,
          ...
          P_("DIFF_PRINT_IUSE",
             "This variable is only used for delayed substitution in PRINT_IUSE.\n"
             "If false, no IUSE data is printed for coreq-diff."));

AddOption(BOOLEAN,
          "UPDATE_PRINT_IUSE",
          "false",
          P_("UPDATE_PRINT_IUSE",
             "This variable is only used for delayed substitution in PRINT_IUSE.\n"
...
AddOption(BOOLEAN,
          "VERSION_IUSE_NORMAL",
          "true",
          P_("VERSION_IUSE_NORMAL",
             "This variable is only used for delayed substitution.\n"
             "If true, coreq --versionlines (nonverbose) outputs IUSE for each version."));

AddOption(BOOLEAN,
          "VERSION_IUSE_VERBOSE",
          "true",
          P_("VERSION_IUSE_VERBOSE",
             "This variable is only used for delayed substitution.\n"
             "If true, coreq --versionlines --verbose outputs IUSE for each version."));
...
AddOption(BOOLEAN,
          ...
          "false",
          P_("VERSION_KEYWORDS_NORMAL",
             "This variable is only used for delayed substitution.\n"
             "If true, coreq --versionlines (nonverbose) outputs KEYWORDS."));

AddOption(BOOLEAN,
          "VERSION_KEYWORDS_VERBOSE",
          "true",
          P_("VERSION_KEYWORDS_VERBOSE",
             "This variable is only used for delayed substitution.\n"
             "If true, coreq --versionlines --verbose outputs KEYWORDS."));
...
AddOption(BOOLEAN,
          "MASKREASONS_NORMAL",
          "true",
          P_("MASKREASONS_NORMAL",
             "This variable is only used for delayed substitution.\n"
             "If true, coreq --versionlines (nonverbose) outputs mask reasons."));

AddOption(BOOLEAN,
          "MASKREASONS_VERBOSE",
          "true",
          P_("MASKREASONS_VERBOSE",
             "This variable is only used for delayed substitution.\n"
             "If true, coreq --versionlines --verbose outputs mask reasons."));

AddOption(BOOLEAN,
          "VERSION_DEPS_NORMAL",
          "false",
          P_("VERSION_DEPS_NORMAL",
             "This variable is only used for delayed substitution.\n"
             "If true, coreq --versionlines (nonverbose) outputs {,R,P}DEPEND."));

AddOption(BOOLEAN,
          "VERSION_DEPS_VERBOSE",
          "true",
          P_("VERSION_DEPS_VERBOSE",
             "This variable is only used for delayed substitution.\n"
             "If true, coreq --versionlines --verbose outputs {,R,P}DEPEND."));

AddOption(BOOLEAN,
          "USE_EFFECTIVE_KEYWORDS",
          "false",
          P_("USE_EFFECTIVE_KEYWORDS",
             "This variable is only used for delayed substitution.\n"
...
AddOption(BOOLEAN,
          ...
          P_("DIFF_NOBEST",
             "This variable is only used for delayed substitution.\n"
             "If true, coreq-diff prints no version if none is installable."));

AddOption(BOOLEAN,
          "DIFF_NOBEST_CHANGE",
          "false",
          P_("DIFF_NOBEST_CHANGE",
             "This variable is only used for delayed substitution.\n"
             "If true, coreq-diff prints no versions if all installable vanished."));

AddOption(STRING, "TERM", "xterm", P_("TERM", "The current terminal. Usually this is set by the environment variable."));

AddOption(STRING,
          "TERM_STATUSLINE",
          "xterm screen tmux rxvt aterm konsole gnome Eterm eterm kterm interix",
          P_("TERM_STATUSLINE",
...
AddOption(STRING,
          "TERM_ALT1",
          "256 [aeEkx]term konsole gnome putty %{TERM_ALT1_ADD}",
          P_("TERM_ALT1",
...
AddOption(STRING, "TERM_ALT1_ADD", "", P_("TERM_ALT1_ADD", "This variable is only used for delayed substitution of TERM_ALT1."));

AddOption(STRING,
          "TERM_ALT2",
          "88 rxvt-unicode[^2]*$ %{TERM_ALT2_ADD}",
          P_("TERM_ALT2",
             "This is a list of regular expressions; if one of it matches TERM, then\n"
             "COLORSCHEME2 is used instead of COLORSCHEME0. The intention is that the\n"
             "specified terminals default to 88 colors."));

AddOption(STRING, "TERM_ALT2_ADD", "", P_("TERM_ALT2_ADD", "This variable is only used for delayed substitution of TERM_ALT2."));
...
AddOption(BOOLEAN, "SORT_INST_USE_ALPHA", "false", P_("SORT_INST_USE_ALPHA", "If false, sort installed useflags by whether they are set."));

AddOption(STRING,
          "CHECK_INSTALLED_OVERLAYS",
          "repository",
          P_("CHECK_INSTALLED_OVERLAYS",
...
AddOption(STRING,
          "MATCH_FIELD_HOMEPAGE",
          "http.*:",
          P_("MATCH_FIELD_HOMEPAGE",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          ...
          "(!use!set!eapi!installed-eapi!slot!installed-slot!use!with-use!without-use)",
...
AddOption(STRING,
          "MATCH_ALGORITHM_REGEX_CASE_FALLBACK",
          "[[:upper:]]",
...
AddOption(BOOLEAN, "TEST_FOR_EMPTY", "true", P_("TEST_FOR_EMPTY", "Defines whether empty entries in /etc/corepkg/package.* are shown with -t."));

AddOption(BOOLEAN, "TEST_KEYWORDS", "true", P_("TEST_KEYWORDS", "Defines whether /etc/corepkg/package.accept_keywords is tested with -t."));

AddOption(BOOLEAN, "TEST_MASK", "true", P_("TEST_MASK", "Defines whether /etc/corepkg/package.mask is tested with -t."));

AddOption(BOOLEAN, "TEST_UNMASK", "true", P_("TEST_UNMASK", "Defines whether /etc/corepkg/package.unmask is tested with -t."));

AddOption(BOOLEAN, "TEST_USE", "true", P_("TEST_USE", "Defines whether /etc/corepkg/package.use is tested with -t."));

AddOption(BOOLEAN, "TEST_ENV", "true", P_("TEST_ENV", "Defines whether /etc/corepkg/package.env is tested with -t."));

AddOption(BOOLEAN, "TEST_LICENSE", "true", P_("TEST_LICENSE", "Defines whether /etc/corepkg/package.license is tested with -t."));

AddOption(BOOLEAN, "TEST_RESTRICT", "true", P_("TEST_RESTRICT", "Defines whether /etc/corepkg/package.accept_restrict is tested with -t."));

AddOption(BOOLEAN, "TEST_CFLAGS", "true", P_("TEST_CFLAGS", "Defines whether /etc/corepkg/package.cflags is tested with -t."));

AddOption(BOOLEAN, "TEST_REMOVED", "true", P_("TEST_REMOVED", "Defines whether removed packages are tested with -t."));

AddOption(BOOLEAN, "TEST_FOR_NONEXISTENT", "true", P_("TEST_FOR_NONEXISTENT", "Defines whether non-existing installed versions are positive for -T."));

AddOption(BOOLEAN,
          "NONEXISTENT_IF_OTHER_OVERLAY",
          "true",
          P_("NONEXISTENT_IF_OTHER_OVERLAY",
...
AddOption(BOOLEAN, "NONEXISTENT_IF_MASKED", "true", P_("NONEXISTENT_IF_MASKED", "Defines whether masked versions are non-existent for TEST_FOR_NONEXISTENT."));

AddOption(BOOLEAN, "TEST_FOR_REDUNDANCY", "true", P_("TEST_FOR_REDUNDANCY", "Defines whether redundant entries are positive for -T."));

AddOption(STRING,
          "ACCEPT_KEYWORDS_AS_ARCH",
          "full",
          P_("ACCEPT_KEYWORDS_AS_ARCH",
...
AddOption(STRING,
          "REDUNDANT_IF_DOUBLE",
          "some",
          P_("REDUNDANT_IF_DOUBLE",
             "Applies if /etc/corepkg/package.accept_keywords lists the same keyword\n"
             "twice for the versions in question."));

AddOption(STRING,
          "REDUNDANT_IF_DOUBLE_LINE",
          "some",
          P_("REDUNDANT_IF_DOUBLE_LINE",
             "Applies if /etc/corepkg/package.accept_keywords has two lines for\n"
             "identical target."));

AddOption(STRING,
          "REDUNDANT_IF_MIXED",
          "false",
          P_("REDUNDANT_IF_MIXED",
             "Applies if /etc/corepkg/package.accept_keywords lists two different\n"
             "keywords, e.g. ~ARCH and -*, for the versions in question."));

AddOption(STRING,
          "REDUNDANT_IF_WEAKER",
          "all-installed",
          P_("REDUNDANT_IF_WEAKER",
             "Applies if /etc/corepkg/package.accept_keywords lists a keywords which can\n"
...
AddOption(STRING,
          ...
          "some",
          P_("REDUNDANT_IF_STRANGE",
             "Applies if /etc/corepkg/package.accept_keywords lists a strange keyword\n"
...
AddOption(STRING,
          ...
          "all-installed",
          P_("REDUNDANT_IF_NO_CHANGE",
             "Applies if /etc/corepkg/package.accept_keywords provides keywords which do\n"
             "not change the availability keywords status for the versions in question."));

AddOption(STRING,
          "REDUNDANT_IF_MASK_NO_CHANGE",
          "all-uninstalled",
          P_("REDUNDANT_IF_MASK_NO_CHANGE",
             "Applies if /etc/corepkg/package.mask contains entries\n"
             "which do not change the mask status for the versions in question."));

AddOption(STRING,
          "REDUNDANT_IF_UNMASK_NO_CHANGE",
          "all-installed",
          P_("REDUNDANT_IF_UNMASK_NO_CHANGE",
             "Applies if /etc/corepkg/package.unmask contains entries\n"
             "which do not change the mask status for the versions in question."));

AddOption(STRING,
          "REDUNDANT_IF_DOUBLE_MASKED",
          "some",
          P_("REDUNDANT_IF_DOUBLE_MASKED",
             "Applies if /etc/corepkg/package.mask matches twice\n"
             "for the versions in question."));

AddOption(STRING,
          "REDUNDANT_IF_DOUBLE_UNMASKED",
          "some",
          P_("REDUNDANT_IF_DOUBLE_UNMASKED",
             "Applies if /etc/corepkg/package.unmask matches twice\n"
             "for the versions in question."));

AddOption(STRING,
          "REDUNDANT_IF_DOUBLE_USE",
          "false",
          P_("REDUNDANT_IF_DOUBLE_USE",
             "Applies if /etc/corepkg/package.use matches twice\n"
             "for the versions in question."));

AddOption(STRING,
          "REDUNDANT_IF_DOUBLE_ENV",
          "false",
          P_("REDUNDANT_IF_DOUBLE_ENV",
             "Applies if /etc/corepkg/package.env matches twice\n"
             "for the versions in question."));

AddOption(STRING,
          "REDUNDANT_IF_DOUBLE_LICENSE",
          "some",
          P_("REDUNDANT_IF_DOUBLE_LICENSE",
             "Applies if /etc/corepkg/package.license matches twice\n"
             "for the versions in question."));

AddOption(STRING,
          "REDUNDANT_IF_DOUBLE_RESTRICT",
          "some",
          P_("REDUNDANT_IF_DOUBLE_RESTRICT",
             "Applies if /etc/corepkg/package.accept_restrict matches twice\n"
             "for the versions in question."));

AddOption(STRING,
          "REDUNDANT_IF_DOUBLE_CFLAGS",
          "false",
          P_("REDUNDANT_IF_DOUBLE_CFLAGS",
             "Applies if /etc/corepkg/package.cflags matches twice\n"
             "for the versions in question."));

AddOption(STRING, "REDUNDANT_IF_IN_KEYWORDS", "-some", P_("REDUNDANT_IF_IN_KEYWORDS", "Applies if /etc/corepkg/package.accept_keywords contains a matching entry."));

AddOption(STRING, "REDUNDANT_IF_IN_MASK", "-some", P_("REDUNDANT_IF_IN_MASK", "Applies if /etc/corepkg/package.mask matches."));

AddOption(STRING, "REDUNDANT_IF_IN_UNMASK", "-some", P_("REDUNDANT_IF_IN_UNMASK", "Applies if /etc/corepkg/package.unmask matches."));

AddOption(STRING, "REDUNDANT_IF_IN_USE", "false", P_("REDUNDANT_IF_IN_USE", "Applies if /etc/corepkg/package.use matches."));

AddOption(STRING, "REDUNDANT_IF_IN_ENV", "false", P_("REDUNDANT_IF_IN_ENV", "Applies if /etc/corepkg/package.env matches."));

AddOption(STRING, "REDUNDANT_IF_IN_LICENSE", "-some", P_("REDUNDANT_IF_IN_LICENSE", "Applies if /etc/corepkg/package.license matches."));

AddOption(STRING, "REDUNDANT_IF_IN_RESTRICT", "-some", P_("REDUNDANT_IF_IN_RESTRICT", "Applies if /etc/corepkg/package.accept_restrict matches."));

AddOption(STRING, "REDUNDANT_IF_IN_CFLAGS", "false", P_("REDUNDANT_IF_IN_CFLAGS", "Applies if /etc/corepkg/package.cflags matches."));

AddOption(STRING,
          "COREQCFGDIR",
          "%{COREPKG_CONFIGROOT}/etc/corepkg",
          P_("COREQCFGDIR",
             "This variable is only used for delayed substitution.\n"
             "It is the directory where coreq searches for its package.*.*/sets.coreq files."));

AddOption(BOOLEAN,
          "SLOT_UPGRADE_FORBID",
          "%{\\COREQCFGDIR}/package.slot_upgrade_forbid",
          P_("SLOT_UPGRADE_FORBID",
...
AddOption(BOOLEAN,
          "SLOT_UPGRADE_ALLOW",
          "%{\\COREQCFGDIR}/package.slot_upgrade_allow",
          P_("SLOT_UPGRADE_ALLOW",
             "If UPGRADE_TO_HIGHEST_SLOT=false, then packages listed in these files/dirs\n"
             "are treated as if UPGRADE_TO_HIGHEST_SLOT=true."));

AddOption(STRING,
          "KEYWORDS_NONEXISTENT",
          "%{\\COREQCFGDIR}/package.accept_keywords.nonexistent "
          "%{\\COREQCFGDIR}/package.keywords.nonexistent",
          P_("KEYWORDS_NONEXISTENT", "Entries listed in these files/dirs are excluded for -t TEST_KEYWORDS."));

AddOption(STRING, "MASK_NONEXISTENT", "%{\\COREQCFGDIR}/package.mask.nonexistent", P_("MASK_NONEXISTENT", "Entries listed in these files/dirs are excluded for -t TEST_MASK."));

AddOption(STRING, "UNMASK_NONEXISTENT", "%{\\COREQCFGDIR}/package.unmask.nonexistent", P_("UNMASK_NONEXISTENT", "Entries listed in these files/dirs are excluded for -t TEST_UNMASK."));

AddOption(STRING, "USE_NONEXISTENT", "%{\\COREQCFGDIR}/package.use.nonexistent", P_("USE_NONEXISTENT", "Entries listed in these files/dire are excluded for -t TEST_USE."));

AddOption(STRING, "ENV_NONEXISTENT", "%{\\COREQCFGDIR}/package.env.nonexistent", P_("ENV_NONEXISTENT", "Entries listed in these files/dire are excluded for -t TEST_ENV."));

AddOption(STRING, "LICENSE_NONEXISTENT", "%{\\COREQCFGDIR}/package.license.nonexistent", P_("LICENSE_NONEXISTENT", "Entries listed in these files/dirs are excluded for -t TEST_LICENSE."));

AddOption(STRING, "RESTRICT_NONEXISTENT", "%{\\COREQCFGDIR}/package.accept_restrict.nonexistent", P_("RESTRICT_NONEXISTENT", "Entries listed in these files/dirs are excluded for -t TEST_RESTRICT."));

AddOption(STRING, "CFLAGS_NONEXISTENT", "%{\\COREQCFGDIR}/package.cflags.nonexistent", P_("CFLAGS_NONEXISTENT", "Entries listed in these files/dirs are excluded for -t TEST_CFLAGS."));

AddOption(STRING, "INSTALLED_NONEXISTENT", "%{\\COREQCFGDIR}/package.installed.nonexistent", P_("INSTALLED_NONEXISTENT", "Packages listed in these files/dirs are excluded for -t TEST_REMOVED."));
...
AddOption(STRING,
          ...
          "%{\\COREQCFGDIR}/package.accept_keywords.nowarn "
          "%{\\COREQCFGDIR}/package.keywords.nowarn "
          "%{\\COREQCFGDIR}/package.mask.nowarn "
          "%{\\COREQCFGDIR}/package.unmask.nowarn "
          "%{\\COREQCFGDIR}/package.use.nowarn "
          "%{\\COREQCFGDIR}/package.env.nowarn "
          "%{\\COREQCFGDIR}/package.license.nowarn "
          "%{\\COREQCFGDIR}/package.accept_restrict.nowarn "
          "%{\\COREQCFGDIR}/package.cflags.nowarn "
          "%{\\COREQCFGDIR}/package.installed.nowarn",
          P_("OBSOLETE_PACKAGE_NOWARN",
             "This variable is used for delayed substitution in PACKAGE_NOWARN if the\n"
             "variable OBSOLETE_NOWARN is set."));

AddOption(STRING,
          "PACKAGE_NOWARN",
          "%{\\COREQCFGDIR}/package.nowarn "
          "%{?OBSOLETE_NOWARN}"
          "%{OBSOLETE_PACKAGE_NOWARN} "
          "%{}"
          "%{ADD_PACKAGE_NOWARN}",
          P_("PACKAGE_NOWARN", "This file/directory contains exceptions for -T tests."));

AddOption(STRING,
          "COREQ_LOCAL_SETS_ADD",
          "",
          P_("COREQ_LOCAL_SETS_ADD",
             "This variable is only used for delayed substitution.\n"
             "It specifies directories for COREQ_LOCAL_SETS."));

AddOption(STRING,
          "COREQ_LOCAL_SETS",
          "%{COREQ_LOCAL_SETS_ADD} "
          "%{\\COREQCFGDIR}/sets.coreq "
          "%{\\COREPKG_CONFIGROOT}/etc/corepkg/sets "
          "*/sets "
          "sets",
          P_("COREQ_LOCAL_SETS", "This is a space-separated list of directories containing set definitions."));
...
AddOption(STRING,
          ...
          P_("EAPI_REGEX",
             ...
             "You might need to modify it according to the installed corepkg version.\n"
...
AddOption(STRING,
          "COLOR_RESET_BG",
          "none;%{BG0S}|none;%{BG1}|none;%{BG2}|none;%{BG3}",
          P_("COLOR_RESET_BG",
             "This variable is only used for delayed substitution.\n"
             "It is the color used for default colors."));
...
AddOption(STRING,
          "COLOR_NAME",
          ",1;%{BG0S}|253,1;%{BG1}|,1;%{BG2}|232;%{BG3}",
          P_("COLOR_NAME",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "COLOR_WORLD",
          "green,1;%{BG0S}|47,1;%{BG1}|green,1;%{BG2}|22,1;%{BG3}|cyan,1|cyan,1",
          P_("COLOR_WORLD",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "COLOR_WORLD_SETS",
          "yellow,1;%{BG0S}|214,1;%{BG1}|blue,1;%{BG2}|33,1;%{BG3}|purple,1|purple,1",
          P_("COLOR_WORLD_SETS",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          ...
          "yellow;%{BG0S}|154,1;%{BG1}|blue;%{BG2}|69,1;%{BG3}",
          P_("COLOR_CATEGORY_SYSTEM",
             "This variable is only used for delayed substitution.\n"
             "It defines the color used for the category of system packages."));

AddOption(STRING,
          "COLOR_CATEGORY_PROFILE",
          "cyan;%{BG0S}|81,1;%{BG1}|cyan;%{BG2}|57,1;%{BG3}",
          P_("COLOR_CATEGORY_PROFILE",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          ...
          "%{COLOR_WORLD_SETS}",
          P_("COLOR_CATEGORY_WORLD_SETS",
             "This variable is only used for delayed substitution.\n"
             "It defines the color used for printing the category of world sets packages."));

AddOption(STRING,
          "COLOR_UPGRADE_TEXT",
          "cyan,1;%{BG0S}|87,1;%{BG1}|blue,1;%{BG2}|21,1;%{BG3}|39,1",
          P_("COLOR_UPGRADE_TEXT",
             "This variable is only used for delayed substitution.\n"
             "It defines the color used for printing upgrade recommendation texts."));

AddOption(STRING,
          "COLOR_DOWNGRADE_TEXT",
          "blue,1;%{BG0S}|135,1;%{BG1}|purple,1;%{BG2}|89,1;%{BG3}|135,1",
          P_("COLOR_DOWNGRADE_TEXT",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "DIFF_COLOR_UNINST_STABILIZE",
          "%{COLOR_STABLE,1}",
          P_("DIFF_COLOR_UNINST_STABILIZE",
             "This variable is only used for delayed substitution.\n"
             "It defines the color used for printing tags for uninstalled packages\n"
             "which have gained a stable version."));

AddOption(STRING,
          "DIFF_COLOR_INST_STABILIZE",
          "%{DIFF_COLOR_UNINST_STABILIZE;inverse}",
          P_("DIFF_COLOR_INST_STABILIZE",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "DIFF_COLOR_BETTER",
          "%{DIFF_COLOR_CHANGED}",
          P_("DIFF_COLOR_BETTER",
             "This variable is only used for delayed substitution.\n"
             "It defines the color used for \"better version\" tags (coreq-diff)."));
...
AddOption(STRING,
          ...
          P_("DIFF_COLOR_WORSE",
             "This variable is only used for delayed substitution.\n"
             "It defines the color used for \"worse version\" tags (coreq-diff)."));

AddOption(STRING,
          "DIFF_COLOR_NEW_TAG",
          "%{DIFF_COLOR_NEW}",
          P_("DIFF_COLOR_NEW_TAG",
             "This variable is only used for delayed substitution.\n"
             "It defines the color used for \"new package\" tags (coreq-diff)."));
...
AddOption(STRING,
          ...
          P_("DIFF_COLOR_NEW",
             "This variable is only used for delayed substitution.\n"
             "It defines the color used for \"new package\" separators (coreq-diff)."));

AddOption(STRING,
          "DIFF_COLOR_DELETE",
          "red,1;%{BG0S}|197,1;%{BG1}|red,1;%{BG2}|197,1;%{BG3}",
          P_("DIFF_COLOR_DELETE",
             "This variable is only used for delayed substitution.\n"
             "It defines the color used for \"deleted package\" separators (coreq-diff)."));

AddOption(STRING,
          "DIFF_COLOR_CHANGED",
          "yellow;%{BG0S}|226;%{BG1}|blue;%{BG2}|24;%{BG3}",
          P_("DIFF_COLOR_CHANGED",
             "This variable is only used for delayed substitution.\n"
             "It defines the color used for \"changed package\" separators (coreq-diff)."));

AddOption(STRING,
          "COLOR_INST_TAG",
          "%{COLOR_STABLE,1;inverse}",
          P_("COLOR_INST_TAG",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "COLOR_DATE",
          "purple,1;%{BG0S}|166;%{BG1}|purple,1;%{BG2}|130,1;%{BG3}",
          P_("COLOR_DATE",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "COLOR_EAPI",
          "green,1;%{BG0S}|80;%{BG1}|green;%{BG2}|80;%{BG3}",
          P_("COLOR_EAPI",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "COLOR_MASKREASONS",
          "red;%{BG0S}|177;%{BG1}|red;%{BG2}|201;%{BG3}",
          P_("COLOR_MASKREASONS",
             "This variable is only used for delayed substitution.\n"
             "It defines the color of the mask reasons output."));

AddOption(STRING,
          "COLOR_SET_USE",
          "red,1;%{BG0S}|125,1;%{BG1}|red,1;%{BG2}|125,1;%{BG3}",
          P_("COLOR_SET_USE",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "COLOR_UNSET_USE",
          "blue,1;%{BG0S}|33;%{BG1}|blue,1;%{BG2}|17;%{BG3}",
          P_("COLOR_UNSET_USE",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "COLOR_VERSION_IUSE",
          ";%{BG0S}|168;%{BG1}|,1;%{BG2}|168,1;%{BG3}|yellow,1|yellow,1",
          P_("COLOR_VERSION_IUSE",
             "This variable is only used for delayed substitution.\n"
             "It defines the color used for printing IUSE for available versions."));

AddOption(STRING,
          "COLOR_COLL_IUSE",
          ";%{BG0S}|38;%{BG1}|,1;%{BG2}|61,1;%{BG3}",
          P_("COLOR_COLL_IUSE",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "COLOR_REQUIRED_USE",
          ";%{BG0S}|165;%{BG1}|,1;%{BG2}|165,1;%{BG3}|yellow,1|yellow,1",
          P_("COLOR_REQUIRED_USE",
             "This variable is only used for delayed substitution.\n"
             "It defines the color used for printing REQUIRED_USE."));

AddOption(STRING,
          "COLOR_USE_EXPAND_START",
          ";%{BG0S}|115;%{BG1}|;%{BG2}|95,1;%{BG3}",
          P_("COLOR_USE_EXPAND_START",
             "This variable is only used for delayed substitution.\n"
             "It defines the color used for printing USE_EXPAND variables."));

AddOption(STRING,
          "COLOR_USE_EXPAND_END",
          "none|;%{BG1}|none|;%{BG3}",
          P_("COLOR_USE_EXPAND_END",
             "This variable is only used for delayed substitution.\n"
             "It defines the color used for printing end of USE_EXPAND variables."));

AddOption(STRING,
          "COLOR_USE_COLL",
          "yellow,1;%{BG0S}|252;%{BG1}|blue;%{BG2}|237,1;%{BG3}",
          P_("COLOR_USE_COLL",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "COLOR_INST_VERSION",
          "black;blue|33,1;%{BG1}|black;green|30,1;%{BG3}|33,1",
          P_("COLOR_INST_VERSION",
             "This variable is only used for delayed substitution.\n"
             "It defines the color used for printing the version of installed packages."));

AddOption(STRING,
          "COLOR_TITLE",
          "green;%{BG0S}|34;%{BG1}|;%{BG2}|240,1;%{BG3}",
          P_("COLOR_TITLE",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "COLOR_INST_TITLE",
          "cyan;%{BG0S}|67;%{BG1}|cyan,1;%{BG2}|67,1;%{BG3}",
          P_("COLOR_INST_TITLE",
             "This variable is only used for delayed substitution.\n"
             "It defines the color used for the title texts for installed versions."));

AddOption(STRING,
          "COLOR_AVAILABLE_TITLE",
          "purple;%{BG0S}|70;%{BG1}|purple;%{BG2}|65,1;%{BG3}",
          P_("COLOR_AVAILABLE_TITLE",
             "This variable is only used for delayed substitution.\n"
             "It defines the color used for the title texts for available versions."));

AddOption(STRING,
          "COLOR_MARKED_VERSION",
          "%{COLOR_MARKED_NAME}",
          P_("COLOR_MARKED_VERSION",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "COLOR_PACKAGESETS",
          "%{COLOR_WORLD_SETS}",
          P_("COLOR_PACKAGESETS",
             "This variable is only used for delayed substitution.\n"
             "It defines the color used for printing the package sets."));

AddOption(STRING,
          "COLOR_MARKED_NAME",
          "red,1;%{BG0S};%{MARK_VERSIONS}|207,1;%{BG1};%{MARK_VERSIONS}|red,1;%{BG2};%{MARK_VERSIONS}|164,1;%{BG3};%{MARK_VERSIONS}",
          P_("COLOR_MARKED_NAME",
             "This variable is only used for delayed substitution.\n"
             "It defines the color used for printing a marked package name."));

AddOption(STRING, "COLOR_OVERLAYKEY", "cyan;%{BG0S}|87;%{BG1}|cyan,1;%{BG2}|26,1;%{BG3}|39", P_("COLOR_OVERLAYKEY", "Color for the overlaykey in version listings."));

AddOption(STRING, "COLOR_VIRTUALKEY", "purple;%{BG0S}|170;%{BG1}|purple,1;%{BG2}|92,1;%{BG3}|170", P_("COLOR_VIRTUALKEY", "Color for the overlaykey for virtual overlays in version listings."));

AddOption(STRING, "COLOR_KEYEND", "%{COLOR_RESET}", P_("COLOR_KEYEND", "Color after printing an overlay key."));

AddOption(STRING, "COLOR_OVERLAYNAME", "%{COLOR_NORMAL}", P_("COLOR_OVERLAYNAME", "Color for printing an overlay name."));

AddOption(STRING, "COLOR_OVERLAYNAMEEND", "", P_("COLOR_OVERLAYNAMEEND", "Color after printing an overlay name."));

AddOption(STRING, "COLOR_NUMBERTEXT", "%{COLOR_NORMAL}", P_("COLOR_NUMBERTEXT", "Color for printing the number of packages."));

AddOption(STRING, "COLOR_NUMBERTEXTEND", "", P_("COLOR_NUMBERTEXTEND", "Color after printing the number of packages."));

AddOption(STRING, "COLOR_SLOTS", "red,1;%{BG0S}|166,1;%{BG1}|red,1;%{BG2}|166,1;%{BG3}", P_("COLOR_SLOTS", "Color for slots. This is only used for delayed substitution."));

AddOption(STRING, "COLOR_BINARY", "blue,1;%{BG0S}|39,1;%{BG1}|blue,1;%{BG2}|39,1;%{BG3}|39,1", P_("COLOR_BINARY", "Color for braces for binaries. This is only used for delayed substitution."));

AddOption(STRING, "COLOR_TBZ", "%{COLOR_BINARY}", P_("COLOR_TBZ", "Color for tag for *.tbz2. This is only used for delayed substitution."));

AddOption(STRING, "COLOR_GPKG", "%{COLOR_BINARY}", P_("COLOR_GPKG", "Color for tag for *.gpkg.tar. This is only used for delayed substitution."));

AddOption(STRING, "COLOR_PAK", "blue,1;%{BG0S}|59,1;%{BG1}|blue,1;%{BG2}|59,1;%{BG3}|59,1", P_("COLOR_PAK", "Color for tag for *.xpak. This is only used for delayed substitution."));

AddOption(STRING, "COLOR_GPKGCOUNT", "%{COLOR_PAKCOUNT}", P_("COLOR_GPKGCOUNT", "Color for number of *.gpkg.tar. This is only used for delayed substitution."));

AddOption(STRING, "COLOR_PAKCOUNT", "purple,1;%{BG0S}|97,1;%{BG1}|blue,1;%{BG2}|97,1;%{BG3}|97,1", P_("COLOR_PAKCOUNT", "Color for number of *.xpak. This is only used for delayed substitution."));

AddOption(STRING, "COLOR_RESTRICT", "red;%{BG0S}|99;%{BG1}|red;%{BG2}|53;%{BG3}|99", P_("COLOR_RESTRICT", "Color for the restriction tags. This is only used for delayed substitution."));

AddOption(STRING, "COLOR_PROPERTIES", "cyan;%{BG0S}|143;%{BG1}|cyan,1;%{BG2}|57;%{BG3}|214", P_("COLOR_PROPERTIES", "Color for the properties tags. This is only used for delayed substitution."));

AddOption(STRING, "COLOR_KEYWORDS", "cyan;%{BG0S}|73;%{BG1}|cyan,1;%{BG2}|26;%{BG3}", P_("COLOR_KEYWORDS", "Color for keywords. This is only used for delayed substitution."));

AddOption(STRING, "COLOR_KEYWORDSS", "%{COLOR_KEYWORDS}", P_("COLOR_KEYWORDSS", "Color for keywords*. This is only used for delayed substitution."));
...
AddOption(STRING,
          "DIFF_CHAR_UNINST_STABILIZE",
          "%{DIFF_CHAR_INST_STABILIZE}",
          P_("DIFF_CHAR_UNINST_STABILIZE",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          ...
          P_("DIFF_CHAR_NEW",
             "This variable is only used for delayed substitution.\n"
             "It defines the character printed for new packages (coreq-diff)."));
...
AddOption(STRING,
          ...
          P_("DIFF_CHAR_BETTER",
             "This variable is only used for delayed substitution.\n"
             "It defines the character used for \"better version\" tags (coreq-diff)."));
...
AddOption(STRING,
          ...
          P_("DIFF_CHAR_WORSE",
             "This variable is only used for delayed substitution.\n"
             "It defines the character used for \"worse version\" tags (coreq-diff)."));

AddOption(STRING,
          "TAG_UPGRADE",
          "(%{COLOR_UPGRADE})%{CHAR_UPGRADE}(%{COLOR_RESET})",
          P_("TAG_UPGRADE",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "TAG_DOWNGRADE",
          "(%{COLOR_DOWNGRADE})%{CHAR_DOWNGRADE}(%{COLOR_RESET})",
          P_("TAG_DOWNGRADE",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "TAG_INSTALLED",
          "(%{COLOR_INST_TAG})%{CHAR_INSTALLED}(%{COLOR_RESET})",
          P_("TAG_INSTALLED",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "TAG_UNINSTALLED",
          "(%{COLOR_UNINST_TAG})%{CHAR_UNINSTALLED}(%{COLOR_RESET})",
          P_("TAG_UNINSTALLED",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "TAG_NEW",
          "(%{DIFF_COLOR_NEW_TAG})%{DIFF_CHAR_NEW}(%{COLOR_RESET})",
          P_("TAG_NEW",
             "This variable is only used for delayed substitution.\n"
             "It defines the tag printed for new packages (coreq-diff)."));
#endif
...
AddOption(STRING,
          "TAG_BETTER",
          "(%{DIFF_COLOR_BETTER})%{DIFF_CHAR_BETTER}(%{COLOR_RESET})",
          P_("TAG_BETTER",
             "This variable is only used for delayed substitution.\n"
             "It defines the tag used for \"better version\" (coreq-diff)."));

AddOption(STRING,
          "TAG_WORSE",
          "(%{DIFF_COLOR_WORSE})%{DIFF_CHAR_WORSE}(%{COLOR_RESET})",
          P_("TAG_WORSE",
             "This variable is only used for delayed substitution.\n"
             "It defines the tag used for \"worse version\" (coreq-diff)."));

AddOption(STRING,
          "STRING_PLAIN_INSTALLED",
          "%{STRING_PLAIN_UNINSTALLED}",
          P_("STRING_PLAIN_INSTALLED",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          ...
          P_("DIFF_STRING_NEW",
             "This variable is only used for delayed substitution.\n"
             "It defines the string used for \"new package\" separators (coreq-diff)."));
...
AddOption(STRING,
          ...
          P_("DIFF_STRING_DELETE",
             "This variable is only used for delayed substitution.\n"
             "It defines the string used for \"deleted package\" separators (coreq-diff)."));
...
AddOption(STRING,
          ...
          P_("DIFF_STRING_CHANGED",
             "This variable is only used for delayed substitution.\n"
             "It defines the string used for \"changed package\" separators (coreq-diff)."));
...
AddOption(STRING,
          ...
          "??"
          "(%{COLOR_RESET})",
          P_("FORMAT_NOBEST_CHANGE",
             "This variable is only used for delayed substitution.\n"
             "It defines what to print after \"->\" if there is no installable."));

AddOption(STRING, "TAG_TBZ", "tbz2", P_("TAG_TBZ", "Tag for *.tbz2. This is only used for delayed substitution."));

AddOption(STRING, "TAG_GPKG", "gpkg", P_("TAG_GPKG", "Tag for *.gpkg.tar. This is only used for delayed substitution."));

AddOption(STRING, "TAG_PAK", "xpak", P_("TAG_PAK", "Tag for *.xpak. This is only used for delayed substitution."));

AddOption(STRING, "TAG_MULTIGPKG", "%{TAG_MULTIPAK}", P_("TAG_MULTIGPKG", "Tag for multiple *.gpkg.tar. This is only used for delayed substitution."));

AddOption(STRING, "TAG_MULTIPAK", ":", P_("TAG_MULTIPAK", "Tag for multiple *.xpak. This is only used for delayed substitution."));

AddOption(STRING, "TAG_RESTRICT_FETCH", "f", P_("TAG_RESTRICT_FETCH", "Tag for RESTRICT=fetch. This is only used for delayed substitution."));

AddOption(STRING, "TAG_RESTRICT_MIRROR", "m", P_("TAG_RESTRICT_MIRROR", "Tag for RESTRICT=mirror. This is only used for delayed substitution."));

AddOption(STRING, "TAG_RESTRICT_PRIMARYURI", "p", P_("TAG_RESTRICT_PRIMARYURI", "Tag for RESTRICT=primaryuri. This is only used for delayed substitution."));

AddOption(STRING, "TAG_RESTRICT_BINCHECKS", "b", P_("TAG_RESTRICT_BINCHECKS", "Tag for RESTRICT=binchecks. This is only used for delayed substitution."));

AddOption(STRING, "TAG_RESTRICT_STRIP", "s", P_("TAG_RESTRICT_STRIP", "Tag for RESTRICT=strip. This is only used for delayed substitution."));

AddOption(STRING, "TAG_RESTRICT_TEST", "t", P_("TAG_RESTRICT_TEST", "Tag for RESTRICT=test. This is only used for delayed substitution."));

AddOption(STRING, "TAG_RESTRICT_USERPRIV", "u", P_("TAG_RESTRICT_USERPRIV", "Tag for RESTRICT=userpriv. This is only used for delayed substitution."));

AddOption(STRING, "TAG_RESTRICT_INSTALLSOURCES", "i", P_("TAG_RESTRICT_INSTALLSOURCES", "Tag for RESTRICT=installsources. This is only used for delayed substitution."));

AddOption(STRING, "TAG_RESTRICT_BINDIST", "d", P_("TAG_RESTRICT_BINDIST", "Tag for RESTRICT=bindist. This is only used for delayed substitution."));

AddOption(STRING, "TAG_RESTRICT_PARALLEL", "P", P_("TAG_RESTRICT_PARALLEL", "Tag for RESTRICT=parallel. This is only used for delayed substitution."));

AddOption(STRING, "TAG_PROPERTIES_INTERACTIVE", "i", P_("TAG_PROPERTIES_INTERACTIVE", "Tag for PROPERTIES=interactive. This is only used for delayed substitution."));

AddOption(STRING, "TAG_PROPERTIES_LIVE", "l", P_("TAG_PROPERTIES_LIVE", "Tag for PROPERTIES=live. This is only used for delayed substitution."));

AddOption(STRING, "TAG_PROPERTIES_VIRTUAL", "v", P_("TAG_PROPERTIES_VIRTUAL", "Tag for PROPERTIES=virtual. This is only used for delayed substitution."));

AddOption(STRING, "TAG_PROPERTIES_SET", "s", P_("TAG_PROPERTIES_SET", "Tag for PROPERTIES=set. This is only used for delayed substitution."));
...
AddOption(STRING,
          "NAMESLOT",
          "<category>/<name>{slots}:<slot>{}%{VERSION_NEWLINE}",
          P_("NAMESLOT",
             "This variable is used as a version formatter.\n"
...
AddOption(STRING, "DATESORT_DATE", "%s	%x %X", P_("DATESORT_DATE", "strftime() format for printing the installation date in DATESORT"));

AddOption(STRING,
          "DATESORT",
          "<date:DATESORT_DATE>\\t%{NAMESLOT}",
          P_("DATESORT",
             "This variable is used as a version formatter.\n"
             "It is an example for usage as <installedversions:DATESORT>. Typical usage:\n"
             "coreq -'*I' --format '<installedversions:DATESORT>' | sort | cut -f2-3"));

AddOption(STRING,
          "FORMAT_SRC_URI",
          "(%{COLOR_SRC_URI})<srcuri>(%{COLOR_RESET})",
          P_("FORMAT_SRC_URI",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "FORMAT_DEPEND",
          "(%{COLOR_DEPEND})<depend*>(%{COLOR_DEPEND_END})",
          P_("FORMAT_DEPEND",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "FORMAT_RDEPEND",
          "(%{COLOR_DEPEND})<rdepend*>(%{COLOR_DEPEND_END})",
          P_("FORMAT_RDEPEND",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "FORMAT_PDEPEND",
          "(%{COLOR_DEPEND})<pdepend*>(%{COLOR_DEPEND_END})",
          P_("FORMAT_PDEPEND",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "FORMAT_BDEPEND",
          "(%{COLOR_DEPEND})<bdepend*>(%{COLOR_DEPEND_END})",
          P_("FORMAT_BDEPEND",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "FORMAT_IDEPEND",
          "(%{COLOR_DEPEND})<idepend*>(%{COLOR_DEPEND_END})",
          P_("FORMAT_IDEPEND",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          ...
          "<colliuse0>"
          "%{else}"
          "%{?COREQ_USE_EXPAND}<colliuse*>%{else}<colliuse>%{}"
          "%{}",
          P_("FORMAT_COLLIUSE",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          ...
          "(%{COLOR_REQUIRED_USE})<requireduse>",
          P_("FORMAT_VERSION_REQUIRED_USE",
             "This variable is only used for delayed substitution.\n"
             "It defines the format for REQUIRED_USE for an available version."));

AddOption(STRING,
          "FORMAT_KEYWORDS",
          "(%{COLOR_KEYWORDS})<versionkeywords>(%{COLOR_RESET})",
          P_("FORMAT_KEYWORDS",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "FORMAT_KEYWORDSS",
          "(%{COLOR_KEYWORDSS})<versionkeywords*>(%{COLOR_RESET})",
          P_("FORMAT_KEYWORDSS",
             "This variable is only used for delayed substitution.\n"
             "It is used for printing colored <keywords*>; color is not reset."));
...
AddOption(STRING,
          ...
          "{versionkeywords}(%{COLOR_KEYWORDSS})$\\{KEYWORDS\\}(%{COLOR_RESET}){}",
          P_("FORMAT_KEYWORDS_EQUAL",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "FORMAT_STABILITY",
          "{!*color}%{FORMAT_MASK_TAG}%{FORMAT_STABILITY_TAG}<$mask><$stable>",
          P_("FORMAT_STABILITY",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "FORMAT_PROPERTIESSEPARATOR",
          "<$sep>{!*sep}{*color}(%{COLOR_PROPERTIES})*",
          P_("FORMAT_PROPERTIESSEPARATOR",
             "This variable is only used for delayed substitution.\n"
             "It sets the initial string and $color for PROPERTIES output."));

AddOption(STRING,
          "FORMAT_RESTRICTSEPARATOR",
          "<$sep>{!*sep}{*color}(%{COLOR_RESTRICT})^",
          P_("FORMAT_RESTRICTSEPARATOR",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "FORMAT_SLOT",
          "(%{COLOR_SLOTS})\\(<slot>\\)(%{COLOR_RESET})",
          P_("FORMAT_SLOT",
             "This variable is only used for delayed substitution.\n"
             "It defines the slot format printed for slotsorted versions."));

AddOption(STRING, "MARKEDVERSION", "(%{COLOR_MARKED_VERSION})<version>(%{COLOR_RESET}){!last} {}", P_("MARKEDVERSION", "This variable is used for <markedversions:MARKEDVERSION>."));
...
AddOption(STRING,
          "PVERSION",
          "%{FORMAT_PVERSION}%{FORMAT_VERSION_END}",
          P_("PVERSION",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "PVERSIONO",
          "%{FORMAT_PVERSION}%{FORMAT_VERSIONO_END}",
          P_("PVERSIONO",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "PVERSIONS",
          "%{FORMAT_PVERSION}%{FORMAT_VERSIONS_END}",
          P_("PVERSIONS",
             "This variable is only used for delayed substitution.\n"
             "It defines the format for printing a plain version with its slot."));
...
AddOption(STRING,
          "AVERSION",
          "%{FORMAT_STABILITY}%{FORMAT_PVERSION}%{FORMAT_VERSION_END}",
          P_("AVERSION",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "AVERSIONO",
          "%{FORMAT_STABILITY}%{FORMAT_PVERSION}%{FORMAT_VERSIONO_END}",
          P_("AVERSIONO",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "AVERSIONS",
          "%{FORMAT_STABILITY}%{FORMAT_PVERSION}%{FORMAT_VERSIONS_END}",
          P_("AVERSIONS",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "IVERSIONS",
          "(%{COLOR_INST_VERSION}){*color}<version>%{FORMAT_VERSIONS_END}",
          P_("IVERSIONS",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "PVERSIONS_VERBOSE",
          "%{PVERSIONS}%{FORMAT_PROPRESTRICT}%{FORMAT_BINARY}%{OVERLAYVER}",
          P_("PVERSIONS_VERBOSE",
             "This variable is only used for delayed substitution.\n"
             "It defines the format for a plain version with most data and slot."));

AddOption(STRING,
          "AVERSIONS_VERBOSE",
          "%{AVERSIONS}%{FORMAT_PROPRESTRICT}%{FORMAT_BINARY}%{OVERLAYVER}",
          P_("AVERSIONS_VERBOSE",
             "This variable is only used for delayed substitution.\n"
             "It defines the format for an available version with most data and slot."));

AddOption(STRING,
          "IVERSIONS_VERBOSE",
          "%{IVERSIONS}%{FORMAT_PROPRESTRICT}%{FORMAT_BINARY}%{OVERLAYVER}",
          P_("IVERSIONS_VERBOSE",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "PVERSIONO_VERBOSE",
          "%{PVERSIONO}%{FORMAT_PROPRESTRICT}%{FORMAT_BINARY}%{OVERLAYVER}",
          P_("PVERSIONO_VERBOSE",
             "This variable is only used for delayed substitution.\n"
             "It defines the format for a plain version with most data, optional subslot."));

AddOption(STRING,
          "AVERSIONO_VERBOSE",
          "%{AVERSIONO}%{FORMAT_PROPRESTRICT}%{FORMAT_BINARY}%{OVERLAYVER}",
          P_("AVERSIONO_VERBOSE",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "PVERSION_VERBOSE",
          "%{PVERSION}%{FORMAT_PROPRESTRICT}%{FORMAT_BINARY}%{OVERLAYVER}",
          P_("PVERSION_VERBOSE",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "AVERSION_VERBOSE",
          "%{AVERSION}%{FORMAT_PROPRESTRICT}%{FORMAT_BINARY}%{OVERLAYVER}",
          P_("AVERSION_VERBOSE",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "COLUMN_STABILITY_AFTER",
          "12",
          P_("COLUMN_STABILITY_AFTER",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          ...
          P_("DIFF_COLUMNA",
             "This variable is only used for delayed substitution.\n"
             "It defines the column for the main tag in coreq-diff."));
...
AddOption(STRING,
          ...
          P_("DIFF_COLUMNB",
             "This variable is only used for delayed substitution.\n"
             "It defines the column after the tags in coreq-diff."));

AddOption(STRING,
          "FORMAT_VER_LINESKIP",
          "%{FORMAT_NEWLINE}\\C<%{I18N_COLUMN_AVAILABLE_TITLE}>",
          P_("FORMAT_VER_LINESKIP",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          ...
          "%{FORMAT_DEPS_NORMAL}"
          "%{FORMAT_MASKREASONS_NORMAL}",
          P_("FORMAT_VERSION_APPENDIX_NORMAL",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "FORMAT_SLOTLINESKIP_VERSIONLINES",
          "%{FORMAT_NEWLINE}\\C<%{COLUMN_SLOT}>%{FORMAT_SLOT}",
          P_("FORMAT_SLOTLINESKIP_VERSIONLINES",
             "This variable is only used for delayed substitution.\n"
             "It defines lineskip + slot if slotsorted versionlines are used."));

AddOption(STRING,
          "FORMAT_SLOTLINESKIP",
          "%{FORMAT_NEWLINE}\\C<%{COLUMN_SLOT}>%{FORMAT_SLOT} \\C<%{COLUMN_SLOT_AFTER}>",
          P_("FORMAT_SLOTLINESKIP",
             "This variable is only used for delayed substitution.\n"
             "It defines lineskip + slot if slotsort but no versionlines are used."));

AddOption(STRING,
          "FORMAT_VERSLINESKIP",
          "%{FORMAT_NEWLINE}\\C<%{COLUMN_STABILITY}>%{FORMAT_STABILITY} \\C<%{COLUMN_STABILITY_AFTER}>",
          P_("FORMAT_VERSLINESKIP",
             "This variable is only used for delayed substitution.\n"
             "It defines lineskip + stability if lineskip is used."));

AddOption(STRING,
          "FORMAT_INST_LINESKIP",
          "%{FORMAT_NEWLINE}\\C<%{I18N_COLUMN_INST_TITLE}>",
          P_("FORMAT_INST_LINESKIP",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          ...
          "%{FORMAT_VERSION_APPENDIX}{last}{*sorted=version}{}",
          P_("VSORTL",
             "This variable is used as a version formatter.\n"
...
AddOption(STRING,
          "VSORT",
          "%{AVERSIONS_VERBOSE}{last}{*sorted=version}{else} {}",
          P_("VSORT",
             "This variable is used as a version formatter.\n"
...
AddOption(STRING,
          ...
          "%{FORMAT_VERSION_APPENDIX}{last}{*sorted=slot}{}",
          P_("SSORTL",
             "This variable is used as a version formatter.\n"
...
AddOption(STRING,
          ...
          "{else} {}"
          "%{AVERSIONO_VERBOSE}{last}{*sorted=slot}{}",
          P_("SSORT",
             "This variable is used as a version formatter.\n"
...
AddOption(STRING,
          "FORMAT_COLL",
          "%{FORMAT_BEFORE_COLL}%{FORMAT_COLLIUSE}%{FORMAT_AFTER_COLL}",
          P_("FORMAT_COLL",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "FORMAT_COLL_SEP",
          "%{FORMAT_BEFORE_COLL_SEP}%{FORMAT_COLLIUSE}%{FORMAT_AFTER_COLL_SEP}",
          P_("FORMAT_COLL_SEP",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          ...
          "(%{COLOR_NORMAL});(%{COLOR_NORMAL_END}) {}",
          P_("DIFF_FORMATLINE_INSTALLEDVERSIONS",
             "This variable is only used for delayed substitution.\n"
             "It defines the format for coreq-diff for installed versions."));
...
AddOption(STRING,
          ...
          P_("DIFF_FORMAT_BEST",
             "This variable is only used for delayed substitution.\n"
             "It defines the coreq-diff format for the best version(s)."));
...
AddOption(STRING,
          ...
          P_("DIFF_FORMAT_BEST_CHANGE",
             "This variable is only used for delayed substitution.\n"
             "It defines the coreq-diff format for the best version(s) in case of changes."));
...
AddOption(STRING,
          ...
          P_("DIFF_FORMAT_OLDBEST_CHANGE",
             "This variable is only used for delayed substitution.\n"
             "It defines the coreq-diff format for the old best versions in case of changes."));
...
AddOption(STRING,
          ...
          " (%{COLOR_NORMAL})->(%{COLOR_NORMAL_END}) "
          "%{DIFF_FORMAT_BEST_CHANGE}",
          P_("DIFF_FORMAT_CHANGED_VERSIONS",
             "This variable is only used for delayed substitution.\n"
             "It defines the coreq-diff format for changed versions."));

AddOption(STRING,
          "FORMAT_OVERLAYKEY",
          "{overlaykey} <overlaykey>{}",
          P_("FORMAT_OVERLAYKEY",
             "This variable is only used for delayed substitution.\n"
             "It defines the format for the printing the optional overlay key."));

AddOption(STRING,
          "FORMATLINE_NAME",
          "%{FORMAT_HEADER} %{FORMAT_NAME}%{FORMAT_OVERLAYKEY}%{FORMAT_NEWLINE}",
          P_("FORMATLINE_NAME",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          ...
          "%{FORMAT_HEADER_VERBOSE} %{FORMAT_NAME}%{FORMAT_OVERLAYKEY}%{FORMAT_NEWLINE}",
          P_("FORMATLINE_NAME_VERBOSE",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          ...
          P_("DIFF_FORMATLINE_NAME_DELETE",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          ...
          P_("DIFF_FORMATLINE_NAME_CHANGED",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          ...
          "\\C<%{I18N_COLUMN_CONTENT}>"
          "%{FORMAT_AVAILABLEVERSIONS}%{FORMAT_NEWLINE}",
          P_("FORMATLINE_AVAILABLEVERSIONS",
             "This variable is only used for delayed substitution.\n"
             "It defines the format for a line with installed versions."));
...
AddOption(STRING,
          ...
          "(%{COLOR_NORMAL}))(%{COLOR_NORMAL_END})",
          P_("DIFF_FORMATLINE_BEST",
             "This variable is only used for delayed substitution.\n"
             "It defines the coreq-diff line for the best versions/slots."));

AddOption(STRING,
          "DIFF_FORMATLINE_CHANGED_VERSIONS",
          "(%{COLOR_NORMAL})\\(%{DIFF_FORMAT_CHANGED_VERSIONS}"
          "(%{COLOR_NORMAL}))(%{COLOR_NORMAL_END})",
          P_("DIFF_FORMATLINE_CHANGED_VERSIONS",
             "This variable is only used for delayed substitution.\n"
             "It defines the coreq-diff line for changed versions."));
...
AddOption(STRING,
          ...
          "%{?PRINT_ALWAYS}{}%{FORMAT_NEWLINE}%{else}%{FORMAT_NEWLINE}{}%{}",
          P_("FORMATLINE_MARKEDVERSIONS",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          ...
          P_("DIFF_FORMATLINE",
             "This variable is only used for delayed substitution.\n"
             "It defines the format for coreq-diff after the versions."));
...
AddOption(STRING,
          ...
          P_("FORMAT_ALL",
             ...
             "It defines the format of the normal output of coreq."));
...
AddOption(STRING,
          ...
          "(%{COLOR_NORMAL_END})"
          "%{FORMAT_FINISH}",
          P_("FORMAT_ALL_COMPACT",
             "This format is only used for delayed substitution in FORMAT_COMPACT.\n"
             "It defines the format of the compact output of coreq (option -c)."));
...
AddOption(STRING,
          ...
          "%{FORMATLINE_LICENSES}"
          "%{FORMAT_FINISH}",
          P_("FORMAT_ALL_VERBOSE",
             "This format is only used for delayed substitution in FORMAT_VERBOSE.\n"
             "It defines the format of the verbose output of coreq (option -v)."));

AddOption(STRING,
          "FORMAT_VERSION_ETCAT",
          "\\C<8>["
          "{!*mask}{*color=(green,1)}"
          "{ismasked}"
          "{*mask}"
          ...
          "\\n",
          P_("VERSION_ETCAT", "This format outputs a version in the style of the etcat script."));

AddOption(STRING,
          "FORMAT_ETCAT",
          "(green,1)*()  (white,1)<category>/<name>() :\\n"
          "<availableversions:FORMAT_VERSION_ETCAT>\\n",
          P_("FORMAT_ETCAT", "This format outputs a package in the style of the etcat script."));

AddOption(STRING,
          "FORMAT",
          "%{FORMAT_ALL}",
          P_("FORMAT",
             "The format of the normal output of coreq.\n"
...
AddOption(STRING,
          ...
          "%{FORMAT_ALL_COMPACT}",
          P_("FORMAT_COMPACT",
             "The format of the compact output of coreq (option -c).\n"
...
AddOption(STRING,
          ...
          "%{FORMAT_ALL_VERBOSE}",
          P_("FORMAT_VERBOSE",
             "The format of the verbose output of coreq (option -v).\n"
             "Do not modify it in a config file; modify FORMAT_ALL_VERBOSE instead."));

AddOption(STRING,
          "FORMAT_TEST_OBSOLETE",
          "%{FORMAT_ALL_COMPACT}",
          P_("FORMAT_TEST_OBSOLETE",
             "The format used for output by the coreq-test-obsolete script.\n"
...
AddOption(STRING,
          ...
          "%{DIFF_FORMATLINE_BEST}"
          "%{DIFF_FORMATLINE}",
          P_("DIFF_FORMAT_ALL_NEW",
             "This format is only used for delayed substitution in DIFF_FORMAT_NEW.\n"
             "It defines the format used for new packages (coreq-diff)."));
...
AddOption(STRING,
          ...
          "%{DIFF_FORMATLINE_BEST}"
          "%{DIFF_FORMATLINE}",
          P_("DIFF_FORMAT_ALL_DELETE",
             "This format is only used for delayed substitution in DIFF_FORMAT_DELETE.\n"
             "It defines the format used for packages that were deleted (coreq-diff)."));
...
AddOption(STRING,
          ...
          "%{DIFF_FORMATLINE_CHANGED_VERSIONS}"
          "%{DIFF_FORMATLINE}",
          P_("DIFF_FORMAT_ALL_CHANGED",
             "This format is only used for delayed substitution in DIFF_FORMAT_CHANGED.\n"
             "It defines the format used for packages that were changed (coreq-diff)."));

AddOption(STRING,
          "DIFF_FORMAT_NEW",
          "%{DIFF_FORMAT_ALL_NEW}",
          P_("DIFF_FORMAT_NEW",
             "The format used for new packages (coreq-diff).\n"
             "Do not modify it in a config file; modify DIFF_FORMAT_ALL_NEW instead."));

AddOption(STRING,
          "DIFF_FORMAT_DELETE",
          "%{DIFF_FORMAT_ALL_DELETE}",
          P_("DIFF_FORMAT_DELETE",
             "The format used for packages that were deleted (coreq-diff).\n"
             "Do not modify it in a config file; modify DIFF_FORMAT_ALL_DELETE instead."));

AddOption(STRING,
          "DIFF_FORMAT_CHANGED",
          "%{DIFF_FORMAT_ALL_CHANGED}",
          P_("DIFF_FORMAT_CHANGED",
             "The format used for packages that were changed (coreq-diff).\n"
             "Do not modify it in a config file; modify DIFF_FORMAT_ALL_CHANGED instead."));

AddOption(STRING, "FORMAT_INSTALLATION_DATE", "%X %x", P_("FORMAT_INSTALLATION_DATE", "strftime() format for printing the installation date in long form"));

AddOption(STRING, "FORMAT_SHORT_INSTALLATION_DATE", "%x", P_("FORMAT_SHORT_INSTALLATION_DATE", "strftime() format for printing the installation date in short form"));
...
AddOption(STRING, "XML_DATE", "%s", P_("XML_DATE", "strftime() format for printing the installation date with --xml."));

AddOption(STRING,
          "FORMAT_MASKREASONS_LINESKIP",
          "%{?WIDETERM}"
          " "
          "%{else}"
          "%{FORMAT_NEWLINE}(%{COLOR_MASKREASONS})"
          "%{}",
          P_("FORMAT_MASKREASONS_LINESKIP", "This string is printed as line separator in <maskreasons>."));

AddOption(STRING,
          "FORMAT_MASKREASONS_SEP",
          "%{?WIDETERM}"
          " - "
          "%{else}"
          "%{FORMAT_NEWLINE}%{FORMAT_NEWLINE}(%{COLOR_MASKREASONS})"
          "%{}",
          P_("FORMAT_MASKREASONS_SEP", "This string is printed as separator for different <maskreasons>."));

AddOption(STRING,
          "FORMAT_MASKREASONSS_LINESKIP",
          "%{?WIDETERM}"
          ...
          "%{}"
          "(%{COLOR_MASKREASONS})",
          P_("FORMAT_MASKREASONSS_LINESKIP", "This string is printed as line separator in <maskreasons*>."));

AddOption(STRING, "FORMAT_MASKREASONSS_SEP", "%{FORMAT_NEWLINE}%{FORMAT_MASKREASONSS_LINESKIP}", P_("FORMAT_MASKREASONSS_SEP", "This string is printed as separator for different <maskreasons*>."));

AddOption(STRING, "FORMAT_BEFORE_SET_USE", "(%{COLOR_SET_USE})", P_("FORMAT_BEFORE_SET_USE", "This string is printed before each set USE flag of an installed version."));

AddOption(STRING, "FORMAT_AFTER_SET_USE", "(%{COLOR_RESET})", P_("FORMAT_AFTER_SET_USE", "This string is printed after each set USE flag of an installed version."));

AddOption(STRING, "FORMAT_BEFORE_UNSET_USE", "(%{COLOR_UNSET_USE})-", P_("FORMAT_BEFORE_UNSET_USE", "This string is printed before each unset USE flag of an installed version."));

AddOption(STRING, "FORMAT_AFTER_UNSET_USE", "(%{COLOR_RESET})", P_("FORMAT_AFTER_UNSET_USE", "This string is printed after each unset USE flag of an installed version."));

AddOption(STRING, "FORMAT_BEFORE_USE_EXPAND_START", "(%{COLOR_USE_EXPAND_START})", P_("FORMAT_BEFORE_USE_EXPAND_START", "This string is printed before the variable name of an USE_EXPAND use value."));

AddOption(STRING, "FORMAT_BEFORE_USE_EXPAND_END", "=\"", P_("FORMAT_BEFORE_USE_EXPAND_END", "This string is printed after the variable name of an USE_EXPAND use value."));

AddOption(STRING, "FORMAT_AFTER_USE_EXPAND", "(%{COLOR_USE_EXPAND_START})\"(%{COLOR_USE_EXPAND_END})", P_("FORMAT_AFTER_USE_EXPAND", "This string is printed at the end of a USE_EXPAND use value."));

AddOption(STRING,
          "FORMAT_BEFORE_IUSE_EXPAND_START",
          "(%{COLOR_USE_EXPAND_START})",
          P_("FORMAT_BEFORE_IUSE_EXPAND_START", "This string is printed before the variable name of an USE_EXPAND iuse value."));

AddOption(STRING, "FORMAT_BEFORE_IUSE_EXPAND_END", "=\"(%{COLOR_VERSION_IUSE})", P_("FORMAT_BEFORE_IUSE_EXPAND_END", "This string is printed after the variable name of an USE_EXPAND iuse value."));

AddOption(STRING,
          "FORMAT_AFTER_IUSE_EXPAND",
          "(%{COLOR_USE_EXPAND_START})\"(%{COLOR_USE_EXPAND_END})",
          P_("FORMAT_AFTER_IUSE_EXPAND", "This string is printed at the end of a USE_EXPAND iuse value."));

AddOption(STRING,
          "FORMAT_BEFORE_COLL_EXPAND_START",
          "(%{COLOR_USE_EXPAND_START})",
          P_("FORMAT_BEFORE_COLL_EXPAND_START",
             "This string is printed before the variable name of an USE_EXPAND collected\n"
             "iuse value."));

AddOption(STRING,
          "FORMAT_BEFORE_COLL_EXPAND_END",
          "=\"(%{COLOR_COLL_IUSE})",
          P_("FORMAT_BEFORE_COLL_EXPAND_END",
             "This string is printed after the variable name of an USE_EXPAND collected\n"
             "iuse value."));

AddOption(STRING,
          "FORMAT_AFTER_COLL_EXPAND",
          "(%{COLOR_USE_EXPAND_START})\"(%{COLOR_USE_EXPAND_END})",
          P_("FORMAT_AFTER_COLL_EXPAND", "This string is printed at the end of a USE_EXPAND collected iuse value."));

AddOption(STRING,
          "FORMAT_BEFORE_IUSE",
          "{!*colliuse}\\t(%{COLOR_NORMAL})[(%{COLOR_NORMAL_END})",
          P_("FORMAT_BEFORE_IUSE",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "FORMAT_BEFORE_COLL",
          "{*colliuse} (%{COLOR_USE_COLL})\\{",
          P_("FORMAT_BEFORE_COLL",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "FORMAT_AFTER_COLL",
          "(%{COLOR_USE_COLL})\\}(%{COLOR_RESET})",
          P_("FORMAT_AFTER_COLL",
             "This variable is only used for delayed substitution.\n"
             "This string is printed after IUSE data for all versions is output.\n"
             "(This is meant for printing after all versions in a line)"));

AddOption(STRING,
          "FORMAT_BEFORE_COLL_SEP",
          "%{FORMAT_NEWLINE}\\C<%{COLUMN_USE}>(%{COLOR_USE_COLL})\\{",
          P_("FORMAT_BEFORE_COLL_SEP",
             "This variable is only used for delayed substitution.\n"
             "This string is printed before IUSE data for all versions is output.\n"
             "(This is meant for printing in a separate line)"));

AddOption(STRING,
          "FORMAT_AFTER_COLL_SEP",
          "%{FORMAT_AFTER_COLL}",
          P_("FORMAT_AFTER_COLL_SEP",
             "This variable is only used for delayed substitution.\n"
             "This string is printed after IUSE data for all versions is output.\n"
             "(This is meant for printing in a separate line)"));
...
AddOption(STRING,
          "COLOR_MASKED",
          "red;%{BG0S}|196;%{BG1}|red;%{BG2}|196;%{BG3}",
          P_("COLOR_MASKED",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "COLOR_UNSTABLE",
          "yellow;%{BG0S}|190;%{BG1}|blue;%{BG2}|21;%{BG3}",
          P_("COLOR_UNSTABLE",
             "This variable is only used for delayed substitution.\n"
...
AddOption(STRING,
          "FORMAT_COLOR_MASKED",
          "(%{COLOR_MASKED})",
          P_("FORMAT_COLOR_MASKED",
             "This variable is only used for delayed substitution.\n"
             "It defines the format to change the color for masked versions."));

AddOption(STRING,
          "FORMAT_COLOR_UNSTABLE",
          "(%{COLOR_UNSTABLE})",
          P_("FORMAT_COLOR_UNSTABLE",
             "This variable is only used for delayed substitution.\n"
