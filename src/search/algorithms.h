...
class BaseAlgorithm {
 ...
 protected:
  ...
  virtual bool can_simplify() const { return true; }
...
class RegexAlgorithm FINAL : public BaseAlgorithm {
 ...
 public:
  ...
  ATTRIBUTE_NONNULL((2)) bool operator()(const char* s, Package* /* p */) const OVERRIDE { return re.match(s); }
};
...
class FuzzyAlgorithm FINAL : public BaseAlgorithm {
 ...
 public:
  ...
  static bool sort_by_levenshtein() { return (!levenshtein_map->empty()); }
