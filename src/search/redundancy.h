...
class RedAtom {
 public:
  Keywords::Redundant red,  ///< Do we search for the redundancy
  ...
  RedAtom() : red(Keywords::RED_NOTHING), all(Keywords::RED_NOTHING), spc(Keywords::RED_NOTHING), ins(Keywords::RED_NOTHING), only(Keywords::RED_NOTHING), oins(Keywords::RED_NOTHING) {}
};
