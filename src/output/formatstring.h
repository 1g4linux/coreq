...
class FormatParser {
	...
	public:
		...
		~FormatParser() {
			coreq_assert_paranoic(keller.empty());
		}
#endif
...
class PrintFormat {
	...
	public:
		...
		/* return true if something was actually printed */
		ATTRIBUTE_NONNULL((2, 5, 6, 7, 8)) bool print(void *entity, GetProperty get_property, Node *root, const DBHeader *dbheader, VarDbPkg *vardbpkg, const CorePkgSettings *ps, const SetStability *s, bool check_only);
