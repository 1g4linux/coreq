...
class EbuildExec {
  ...
  **/
  ...
  void remove_handler();
  int make_tempfile();
  bool corepkgq(std::string* result, const char* var) const;
  bool calc_settings();
 ...
 public:
  ...
  ATTRIBUTE_NONNULL_ EbuildExec(bool will_use_sh, const BasicCache* b) : base(b), have_set_signals(false), cache_defined(false), use_ebuild_sh(will_use_sh) {}
