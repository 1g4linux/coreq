...
class ParseCache FINAL : public BasicCache {
 private:
  ...
  bool try_parse, nosubst, ebuild_sh, corepkg3_0_24;
  ...
  ATTRIBUTE_NONNULL_ void set_checking(std::string* str, const char* item, const VarsReader& ebuild) { set_checking(str, item, ebuild, NULLPTR); }
 ...
 public:
  ...
  void setVerbose() OVERRIDE { verbose = true; }
  ...
  ATTRIBUTE_CONST_VIRTUAL bool use_prefixport() const OVERRIDE { return true; }
