...
/**
Parent class of every cache that coreq can use
**/
...
class BasicCache {
 ...
 public:
  ...
  BasicCache() { corepkgsettings = NULLPTR; }
  ...
  **/
  ...
  ATTRIBUTE_CONST_VIRTUAL virtual bool use_prefixport() const { return false; }
  ...
  **/
  ...
  Set overlay-key
  **/
  virtual void setKey(ExtendedVersion::Overlay key) { m_overlay_key = key; }

  /**
  Set overlay-name
  **/
  virtual void setOverlayName(const std::string& name) { m_overlay_name = name; }
  ...
  **/
  ...
  Get overlay-key
  **/
  ExtendedVersion::Overlay getKey() const { return m_overlay_key; }

  /**
  Get overlay-name
  **/
  const std::string& getOverlayName() const { return m_overlay_name; }

  /**
  Get scheme for this cache
  **/
  std::string getPath() const { return m_scheme; }
  ...
  **/
  virtual void setErrorCallback(ErrorCallback error_callback) { m_error_callback = error_callback; }
  ...
  **/
  ATTRIBUTE_CONST_VIRTUAL virtual bool can_read_multiple_categories() const { return false; }
  ...
  **/
  virtual bool readCategories(PackageTree* /* packagetree */, const char* /* cat_name */, Category* /* category */) { return true; }
  bool readCategories(PackageTree* packagetree) { return readCategories(packagetree, NULLPTR, NULLPTR); }
  ...
  This is used in coreq-update to avoid unnecessary updates of the percentage bar.
  ...
  **/
  ...
  @return false if some error caused incomplete read.
  **/
  ATTRIBUTE_NONNULL_ virtual bool readCategory(Category* cat) { return readCategories(NULLPTR, m_catname.c_str(), cat); }
  ...
  **/
  virtual void readCategoryFinalize() { m_catname.clear(); }

  ATTRIBUTE_NONNULL_ virtual bool get_time(std::time_t* /* time */, const std::string& /* pkg_name */, const std::string& /* ver_name */) const { return 0; }

  ATTRIBUTE_NONNULL_ virtual const char* get_md5sum(const std::string& /* pkg_name */, const std::string& /* ver_name */) const { return NULLPTR; }
