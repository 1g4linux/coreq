...
#ifndef SRC_COREQTK_FILENAMES_H_
#define SRC_COREQTK_FILENAMES_H_ 1
...
**/
ATTRIBUTE_NONNULL_ WordVec::const_iterator find_filenames(const WordVec::const_iterator start, const WordVec::const_iterator end, const char* search, bool list_of_patterns, bool resolve_list);
ATTRIBUTE_NONNULL_ inline static WordVec::const_iterator find_filenames(const WordVec::const_iterator start, const WordVec::const_iterator end, const char* search, bool list_of_patterns);
inline static WordVec::const_iterator find_filenames(const WordVec::const_iterator start, const WordVec::const_iterator end, const char* search, bool list_of_patterns) {
  return find_filenames(start, end, search, list_of_patterns, false);
}
ATTRIBUTE_NONNULL_ inline static WordVec::const_iterator find_filenames(const WordVec::const_iterator start, const WordVec::const_iterator end, const char* search);
inline static WordVec::const_iterator find_filenames(const WordVec::const_iterator start, const WordVec::const_iterator end, const char* search) {
...
#endif  // SRC_COREQTK_FILENAMES_H_
