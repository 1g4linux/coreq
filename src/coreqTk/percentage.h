...
#ifndef SRC_COREQTK_PERCENTAGE_H_
#define SRC_COREQTK_PERCENTAGE_H_ 1
...
class PercentStatus {
 public:
  typedef coreq::Treesize Percentage;
...
#endif  // SRC_COREQTK_PERCENTAGE_H_
