...
#ifndef SRC_COREQTK_UTILS_H_
#define SRC_COREQTK_UTILS_H_ 1
...
**/
ATTRIBUTE_NONNULL((1, 2)) bool pushback_lines(const char* file, LineVec* v, bool recursive, bool keep_empty, coreq::SignedBool keep_comments, std::string* errtext);
ATTRIBUTE_NONNULL_ inline static bool pushback_lines(const char* file, LineVec* v, bool recursive, bool keep_empty, coreq::SignedBool keep_comments);
inline static bool pushback_lines(const char* file, LineVec* v, bool recursive, bool keep_empty, coreq::SignedBool keep_comments) {
...
/**
Print version of coreq to stdout.
**/
ATTRIBUTE_NORETURN void dump_version();

#endif  // SRC_COREQTK_UTILS_H_
