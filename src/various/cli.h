...
ATTRIBUTE_NONNULL_ void parse_cli(MatchTree *matchtree, CoreqRc *coreqrc, VarDbPkg *varpkg_db, CorePkgSettings *corepkgsettings, const PrintFormat *print_format, const SetStability *stability, const DBHeader *header, const ParseError *parse_error, MaskList<Mask> **marked_list, const ArgumentReader& ar);

/*
	If you want to add a new parameter to coreq just insert a line into
