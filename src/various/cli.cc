...
static bool optional_numeric_increase(ArgumentReader::const_iterator* arg, const ArgumentReader& ar) {
  ArgumentReader::const_iterator next(*arg);
  if (likely(++next != ar.end()) && (next->type == Parameter::ARGUMENT) && is_numeric(next->m_argument)) {
    *arg = next;
    return true;
  }
  return false;
...
#define NEW_TEST                                                                                      \
  do {                                                                                                \
    test = new PackageTest(varpkg_db, corepkgsettings, print_format, stability, header, parse_error); \
  } while (0)
...
void parse_cli(MatchTree* matchtree,
               CoreqRc* coreqrc,
               VarDbPkg* varpkg_db,
  ...
  for (ArgumentReader::const_iterator arg(ar.begin()); likely(arg != ar.end()); ++arg) {
    switch (**arg) {
      ...
      case '|':
        force_test = curr_pipe = use_pipe = true;
        break;
      case 'I':
        USE_TEST;
        test->Installed();
      ...
      case 'u':
        USE_TEST;
        test->Upgrade(coreqrc->getLocalMode("UPGRADE_LOCAL_MODE"));
        break;
      ...
      case O_OVERLAY:
        ...
        if (optional_increase(&arg, ar)) {
          header->get_overlay_vector(test->OverlayList(), arg->m_argument, (*corepkgsettings)["PORTDIR"].c_str());
          break;
        }
        ATTRIBUTE_FALLTHROUGH
      case O_NONVIRTUAL:
      ...
      case O_ONLY_OVERLAY:
        USE_TEST;
        if (optional_increase(&arg, ar)) {
          header->get_overlay_vector(test->OverlayOnlyList(), arg->m_argument, (*corepkgsettings)["PORTDIR"].c_str());
          break;
        }
        header->get_overlay_vector(test->OverlayOnlyList(), "", (*corepkgsettings)["PORTDIR"].c_str());
        break;
      case O_INSTALLED_OVERLAY:
        USE_TEST;
        if (optional_increase(&arg, ar)) {
          header->get_overlay_vector(test->InOverlayInstList(), arg->m_argument, (*corepkgsettings)["PORTDIR"].c_str());
          break;
        }
        ATTRIBUTE_FALLTHROUGH
      case O_INSTALLED_SOME:
        USE_TEST;
        header->get_overlay_vector(test->InOverlayInstList(), "", (*corepkgsettings)["PORTDIR"].c_str());
        break;
      case O_FROM_OVERLAY:
        USE_TEST;
        if (optional_increase(&arg, ar)) {
          header->get_overlay_vector(test->FromOverlayInstList(), arg->m_argument, (*corepkgsettings)["PORTDIR"].c_str());
      ...
      case 'J':
        USE_TEST;
        header->get_overlay_vector(test->FromOverlayInstList(), "", (*corepkgsettings)["PORTDIR"].c_str());
      ...
      case 'T':
        USE_TEST;
        {
          ...
          if (likely(coreqrc->getBool("TEST_FOR_REDUNDANCY"))) {
            coreqrc->getRedundantFlags("REDUNDANT_IF_DOUBLE", Keywords::RED_DOUBLE, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_DOUBLE_LINE", Keywords::RED_DOUBLE_LINE, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_MIXED", Keywords::RED_MIXED, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_WEAKER", Keywords::RED_WEAKER, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_STRANGE", Keywords::RED_STRANGE, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_NO_CHANGE", Keywords::RED_NO_CHANGE, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_MASK_NO_CHANGE", Keywords::RED_MASK, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_UNMASK_NO_CHANGE", Keywords::RED_UNMASK, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_DOUBLE_MASKED", Keywords::RED_DOUBLE_MASK, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_DOUBLE_UNMASKED", Keywords::RED_DOUBLE_UNMASK, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_DOUBLE_USE", Keywords::RED_DOUBLE_USE, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_DOUBLE_ENV", Keywords::RED_DOUBLE_ENV, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_DOUBLE_LICENSE", Keywords::RED_DOUBLE_LICENSE, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_DOUBLE_RESTRICT", Keywords::RED_DOUBLE_RESTRICT, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_DOUBLE_CFLAGS", Keywords::RED_DOUBLE_CFLAGS, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_IN_KEYWORDS", Keywords::RED_IN_KEYWORDS, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_IN_MASK", Keywords::RED_IN_MASK, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_IN_UNMASK", Keywords::RED_IN_UNMASK, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_IN_USE", Keywords::RED_IN_USE, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_IN_ENV", Keywords::RED_IN_ENV, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_IN_LICENSE", Keywords::RED_IN_LICENSE, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_IN_RESTRICT", Keywords::RED_IN_RESTRICT, &red);
            coreqrc->getRedundantFlags("REDUNDANT_IF_IN_CFLAGS", Keywords::RED_IN_CFLAGS, &red);
          }
          PackageTest::TestInstalled test_installed = PackageTest::INS_NONE;
          if (likely(coreqrc->getBool("TEST_FOR_NONEXISTENT"))) {
            test_installed |= PackageTest::INS_NONEXISTENT;
            if (coreqrc->getBool("NONEXISTENT_IF_MASKED"))
              test_installed |= PackageTest::INS_MASKED;
            if (coreqrc->getBool("NONEXISTENT_IF_OTHER_OVERLAY")) {
      ...
      case O_DEPS:
        ...
        *test |= PackageTest::DEPS;
        break;
      case O_AVAILABLE_DEPEND:
        USE_TEST;
        *test |= PackageTest::DEPENDA;
        break;
      case O_AVAILABLE_RDEPEND:
        USE_TEST;
        *test |= PackageTest::RDEPENDA;
        break;
      case O_AVAILABLE_PDEPEND:
        USE_TEST;
        *test |= PackageTest::PDEPENDA;
        break;
      case O_AVAILABLE_BDEPEND:
        USE_TEST;
        *test |= PackageTest::BDEPENDA;
        break;
      case O_AVAILABLE_IDEPEND:
        USE_TEST;
        *test |= PackageTest::IDEPENDA;
        break;
      case O_AVAILABLE_DEPS:
        USE_TEST;
        *test |= PackageTest::DEPSA;
        break;
      case O_INSTALLED_DEPEND:
        USE_TEST;
        *test |= PackageTest::DEPENDI;
        break;
      case O_INSTALLED_RDEPEND:
        USE_TEST;
        *test |= PackageTest::RDEPENDI;
        break;
      case O_INSTALLED_PDEPEND:
        USE_TEST;
        *test |= PackageTest::PDEPENDI;
        break;
      case O_INSTALLED_BDEPEND:
        USE_TEST;
        *test |= PackageTest::BDEPENDI;
        break;
      case O_INSTALLED_IDEPEND:
        USE_TEST;
        *test |= PackageTest::IDEPENDI;
        break;
      case O_INSTALLED_DEPS:
        USE_TEST;
      ...
      case O_SEARCH_SLOT:
        ...
        *test |= PackageTest::SLOT;
        break;
      case O_SEARCH_FULLSLOT:
        USE_TEST;
        *test |= PackageTest::FULLSLOT;
        break;
      case O_SEARCH_INST_SLOT:
        USE_TEST;
        *test |= PackageTest::INST_SLOT;
        break;
      case O_SEARCH_INST_FULLSLOT:
        USE_TEST;
  ...
  *marked_list = NULLPTR;
  ...
  while (likely(!std::cin.eof())) {
    ...
    for (WordVec::const_iterator word(wordlist.begin()); likely(word != wordlist.end()); ++word) {
