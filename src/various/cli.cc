...
void parse_cli(MatchTree *matchtree, CoreqRc *coreqrc, VarDbPkg *varpkg_db, CorePkgSettings *corepkgsettings, const PrintFormat *print_format, const SetStability *stability, const DBHeader *header, const ParseError *parse_error, MaskList<Mask> **marked_list, const ArgumentReader& ar) {
		...
		switch(**arg) {
			...
			case 'T': USE_TEST; {
				...
				if(likely(coreqrc->getBool("TEST_FOR_REDUNDANCY"))) {
					coreqrc->getRedundantFlags("REDUNDANT_IF_DOUBLE",
						Keywords::RED_DOUBLE, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_DOUBLE_LINE",
						Keywords::RED_DOUBLE_LINE, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_MIXED",
						Keywords::RED_MIXED, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_WEAKER",
						Keywords::RED_WEAKER, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_STRANGE",
						Keywords::RED_STRANGE, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_NO_CHANGE",
						Keywords::RED_NO_CHANGE, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_MASK_NO_CHANGE",
						Keywords::RED_MASK, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_UNMASK_NO_CHANGE",
						Keywords::RED_UNMASK, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_DOUBLE_MASKED",
						Keywords::RED_DOUBLE_MASK, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_DOUBLE_UNMASKED",
						Keywords::RED_DOUBLE_UNMASK, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_DOUBLE_USE",
						Keywords::RED_DOUBLE_USE, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_DOUBLE_ENV",
						Keywords::RED_DOUBLE_ENV, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_DOUBLE_LICENSE",
						Keywords::RED_DOUBLE_LICENSE, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_DOUBLE_RESTRICT",
						Keywords::RED_DOUBLE_RESTRICT, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_DOUBLE_CFLAGS",
						Keywords::RED_DOUBLE_CFLAGS, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_IN_KEYWORDS",
						Keywords::RED_IN_KEYWORDS, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_IN_MASK",
						Keywords::RED_IN_MASK, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_IN_UNMASK",
						Keywords::RED_IN_UNMASK, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_IN_USE",
						Keywords::RED_IN_USE, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_IN_ENV",
						Keywords::RED_IN_ENV, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_IN_LICENSE",
						Keywords::RED_IN_LICENSE, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_IN_RESTRICT",
						Keywords::RED_IN_RESTRICT, &red);
					coreqrc->getRedundantFlags("REDUNDANT_IF_IN_CFLAGS",
			...
			case O_DEPS: USE_TEST;
				*test |= PackageTest::DEPS;
				break;
			case O_AVAILABLE_DEPEND: USE_TEST;
				*test |= PackageTest::DEPENDA;
				break;
			case O_AVAILABLE_RDEPEND: USE_TEST;
				*test |= PackageTest::RDEPENDA;
				break;
			case O_AVAILABLE_PDEPEND: USE_TEST;
			...
			case O_AVAILABLE_DEPS: USE_TEST;
				*test |= PackageTest::DEPSA;
				break;
			case O_INSTALLED_DEPEND: USE_TEST;
				*test |= PackageTest::DEPENDI;
				break;
			case O_INSTALLED_RDEPEND: USE_TEST;
				*test |= PackageTest::RDEPENDI;
				break;
			case O_INSTALLED_PDEPEND: USE_TEST;
