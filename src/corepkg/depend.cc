...
void Depend::set(const string& depend, const string& rdepend, const string& pdepend, const string& bdepend, const string& idepend, bool normspace) {
  ...
  subst_the_same(&m_pdepend, m_rdepend, c_rdepend_shortcut) || subst_the_same(&m_pdepend, m_depend, c_depend_shortcut);
...
bool Depend::operator==(const Depend& d) const {
  return ((get_depend() == d.get_depend()) && (get_rdepend() == d.get_rdepend()) && (get_pdepend() == d.get_pdepend()) && (get_bdepend() == d.get_bdepend()) && (get_idepend() == d.get_idepend()));
}
