...
class CorePkgSettings : public WordIterateMap {
	...
	public:
		...
		**/
		...
		ATTRIBUTE_NONNULL_ CorePkgSettings(CoreqRc *coreqrc, const ParseError *e, bool getlocal, bool init_world, bool print_profile_paths) {
			init(coreqrc, e, getlocal, init_world, print_profile_paths);
		}

		ATTRIBUTE_NONNULL_ CorePkgSettings(CoreqRc *coreqrc, const ParseError *e, bool getlocal, bool init_world) {
			init(coreqrc, e, getlocal, init_world, false);
		}
